/**
  * @file       MxSeqSmpNodenode-6056.cpp
...
#include "MxSeqSmpNodenode-6056.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-6056::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-6056::Impl::myXsdID = 6056;
	const std::string MxSeqSmpNodenode-6056::Impl::myXmlTypeName = "node-6056";
	const std::string MxSeqSmpNodenode-6056::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-6056::Impl::myDocumentation = "No XSD Documentation.";
