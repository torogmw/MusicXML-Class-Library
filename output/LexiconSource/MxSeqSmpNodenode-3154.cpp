/**
  * @file       MxSeqSmpNodenode-3154.cpp
  * @class      lexicon::MxSeqSmpNodenode-3154
  * @author     Matthew James Briggs
  * @email      matthew.james.briggs@gmail.com
  * @url        http://matthewjamesbriggs.com
  * @date       2014-12-11 15:41:07
  * @project    Lexicon
  * @version    1.0
  * @musicxmlid 3154
  * 
...
#include "MxSeqSmpNodenode-3154.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-3154::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-3154::Impl::myXsdID = 3154;
	const std::string MxSeqSmpNodenode-3154::Impl::myXmlTypeName = "node-3154";
	const std::string MxSeqSmpNodenode-3154::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-3154::Impl::myDocumentation = "No XSD Documentation.";
