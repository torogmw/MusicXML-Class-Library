...
namespace lexicon
{
/* MxSeqSmpNodenode-4250 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-4250 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-4250();
		virtual ~MxSeqSmpNodenode-4250();
		MxSeqSmpNodenode-4250( const MxSeqSmpNodenode-4250& other );
		MxSeqSmpNodenode-4250& operator=( const MxSeqSmpNodenode-4250& other );
