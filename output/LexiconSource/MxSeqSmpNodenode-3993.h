...
namespace lexicon
{
/* MxSeqSmpNodenode-3993 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-3993 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-3993();
		virtual ~MxSeqSmpNodenode-3993();
		MxSeqSmpNodenode-3993( const MxSeqSmpNodenode-3993& other );
		MxSeqSmpNodenode-3993& operator=( const MxSeqSmpNodenode-3993& other );
