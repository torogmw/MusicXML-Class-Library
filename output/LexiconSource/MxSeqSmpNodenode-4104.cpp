/**
  * @file       MxSeqSmpNodenode-4104.cpp
  * @class      lexicon::MxSeqSmpNodenode-4104
  * @author     Matthew James Briggs
  * @email      matthew.james.briggs@gmail.com
  * @url        http://matthewjamesbriggs.com
  * @date       2014-12-11 15:41:43
  * @project    Lexicon
  * @version    1.0
  * @musicxmlid 4104
  * 
...
#include "MxSeqSmpNodenode-4104.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-4104::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-4104::Impl::myXsdID = 4104;
	const std::string MxSeqSmpNodenode-4104::Impl::myXmlTypeName = "node-4104";
	const std::string MxSeqSmpNodenode-4104::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-4104::Impl::myDocumentation = "No XSD Documentation.";
