...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode6271::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode6271::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode6271::Impl::myDocumentation = "";
