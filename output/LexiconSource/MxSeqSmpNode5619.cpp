...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode5619::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode5619::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode5619::Impl::myDocumentation = "";
