...
namespace lexicon
{
/* MxSeqSmpNodenode-4104 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-4104 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-4104();
		virtual ~MxSeqSmpNodenode-4104();
		MxSeqSmpNodenode-4104( const MxSeqSmpNodenode-4104& other );
		MxSeqSmpNodenode-4104& operator=( const MxSeqSmpNodenode-4104& other );
