...
namespace lexicon
{
/* MxSeqSmpNodenode-4143 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-4143 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-4143();
		virtual ~MxSeqSmpNodenode-4143();
		MxSeqSmpNodenode-4143( const MxSeqSmpNodenode-4143& other );
		MxSeqSmpNodenode-4143& operator=( const MxSeqSmpNodenode-4143& other );
