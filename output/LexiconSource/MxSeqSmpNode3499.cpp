...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode3499::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode3499::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode3499::Impl::myDocumentation = "";
