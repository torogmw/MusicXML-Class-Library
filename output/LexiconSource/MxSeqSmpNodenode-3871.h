...
namespace lexicon
{
/* MxSeqSmpNodenode-3871 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-3871 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-3871();
		virtual ~MxSeqSmpNodenode-3871();
		MxSeqSmpNodenode-3871( const MxSeqSmpNodenode-3871& other );
		MxSeqSmpNodenode-3871& operator=( const MxSeqSmpNodenode-3871& other );
