/**
  * @file       MxSeqSmpNodenode-3245.cpp
  * @class      lexicon::MxSeqSmpNodenode-3245
  * @author     Matthew James Briggs
  * @email      matthew.james.briggs@gmail.com
  * @url        http://matthewjamesbriggs.com
  * @date       2014-12-11 15:41:35
  * @project    Lexicon
  * @version    1.0
  * @musicxmlid 3245
  * 
...
#include "MxSeqSmpNodenode-3245.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-3245::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-3245::Impl::myXsdID = 3245;
	const std::string MxSeqSmpNodenode-3245::Impl::myXmlTypeName = "node-3245";
	const std::string MxSeqSmpNodenode-3245::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-3245::Impl::myDocumentation = "No XSD Documentation.";
