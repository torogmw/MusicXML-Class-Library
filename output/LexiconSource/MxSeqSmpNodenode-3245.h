...
namespace lexicon
{
/* MxSeqSmpNodenode-3245 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-3245 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-3245();
		virtual ~MxSeqSmpNodenode-3245();
		MxSeqSmpNodenode-3245( const MxSeqSmpNodenode-3245& other );
		MxSeqSmpNodenode-3245& operator=( const MxSeqSmpNodenode-3245& other );
