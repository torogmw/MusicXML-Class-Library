...
namespace lexicon
{
/* MxSeqSmpNodenode-6271 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-6271 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-6271();
		virtual ~MxSeqSmpNodenode-6271();
		MxSeqSmpNodenode-6271( const MxSeqSmpNodenode-6271& other );
		MxSeqSmpNodenode-6271& operator=( const MxSeqSmpNodenode-6271& other );
