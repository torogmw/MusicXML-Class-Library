...
namespace lexicon
{
/* MxSeqSmpNodenode-4224 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-4224 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-4224();
		virtual ~MxSeqSmpNodenode-4224();
		MxSeqSmpNodenode-4224( const MxSeqSmpNodenode-4224& other );
		MxSeqSmpNodenode-4224& operator=( const MxSeqSmpNodenode-4224& other );
