...
namespace lexicon
{
/* MxSeqSmpNodenode-3499 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-3499 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-3499();
		virtual ~MxSeqSmpNodenode-3499();
		MxSeqSmpNodenode-3499( const MxSeqSmpNodenode-3499& other );
		MxSeqSmpNodenode-3499& operator=( const MxSeqSmpNodenode-3499& other );
