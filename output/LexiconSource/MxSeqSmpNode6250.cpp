...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode6250::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode6250::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode6250::Impl::myDocumentation = "";
