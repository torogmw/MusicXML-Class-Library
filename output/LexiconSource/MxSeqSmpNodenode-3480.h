...
namespace lexicon
{
/* MxSeqSmpNodenode-3480 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-3480 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-3480();
		virtual ~MxSeqSmpNodenode-3480();
		MxSeqSmpNodenode-3480( const MxSeqSmpNodenode-3480& other );
		MxSeqSmpNodenode-3480& operator=( const MxSeqSmpNodenode-3480& other );
