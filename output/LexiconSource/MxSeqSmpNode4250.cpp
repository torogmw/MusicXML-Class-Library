...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode4250::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode4250::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode4250::Impl::myDocumentation = "";
