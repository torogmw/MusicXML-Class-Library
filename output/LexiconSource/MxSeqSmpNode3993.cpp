...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const std::string MxSeqSmpNode3993::Impl::myXmlTypeName = "";
	const std::string MxSeqSmpNode3993::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNode3993::Impl::myDocumentation = "";
