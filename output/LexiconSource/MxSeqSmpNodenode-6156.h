...
namespace lexicon
{
/* MxSeqSmpNodenode-6156 -------------------------------------------------------------- */

	class MxSeqSmpNodenode-6156 : public MxSeq
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNodenode-6156();
		virtual ~MxSeqSmpNodenode-6156();
		MxSeqSmpNodenode-6156( const MxSeqSmpNodenode-6156& other );
		MxSeqSmpNodenode-6156& operator=( const MxSeqSmpNodenode-6156& other );
