/**
  * @file       MxSeqSmpNodenode-6156.cpp
  * @class      lexicon::MxSeqSmpNodenode-6156
  * @author     Matthew James Briggs
  * @email      matthew.james.briggs@gmail.com
  * @url        http://matthewjamesbriggs.com
  * @date       2014-12-11 15:41:51
  * @project    Lexicon
  * @version    1.0
  * @musicxmlid 6156
  * 
...
#include "MxSeqSmpNodenode-6156.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-6156::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-6156::Impl::myXsdID = 6156;
	const std::string MxSeqSmpNodenode-6156::Impl::myXmlTypeName = "node-6156";
	const std::string MxSeqSmpNodenode-6156::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-6156::Impl::myDocumentation = "No XSD Documentation.";
