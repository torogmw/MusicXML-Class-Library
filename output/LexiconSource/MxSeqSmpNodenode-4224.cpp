/**
  * @file       MxSeqSmpNodenode-4224.cpp
  * @class      lexicon::MxSeqSmpNodenode-4224
...
#include "MxSeqSmpNodenode-4224.h"

/* Impl ------------------------------------------------------------------------------- */

namespace lexicon
{
	struct MxSeqSmpNodenode-4224::Impl
	{
		Impl()
		{}
...
/* Stringing and Streaming ------------------------------------------------------------ */
	...
	const int MxSeqSmpNodenode-4224::Impl::myXsdID = 4224;
	const std::string MxSeqSmpNodenode-4224::Impl::myXmlTypeName = "node-4224";
	const std::string MxSeqSmpNodenode-4224::Impl::myCppClassName = "DefaultConstructed";
	const std::string MxSeqSmpNodenode-4224::Impl::myDocumentation = "No XSD Documentation.";
