...
/* MxSeqSmpNode5619 ------------------------------------------------------------------- */
	...
	class MxSeqSmpNode5619 : public MxIndentable
	{
	public:
...
/* Constructor, Destructor, Copy, Assignment ------------------------------------------ */
		...
		MxSeqSmpNode5619();
		virtual ~MxSeqSmpNode5619();
		MxSeqSmpNode5619( const MxSeqSmpNode5619& other );
		MxSeqSmpNode5619& operator=( const MxSeqSmpNode5619& other );
