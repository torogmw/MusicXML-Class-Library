...
TEST( ctorAttributeValues0, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues1, MxEsTap )
{
	MxEsTap object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEsTap )
{
	MxEsTap object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEsTap )
{
	MxEsTap object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues5, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues6, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues7, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues8, MxEsTap )
{
	MxEsTap object;
...
TEST( ctorAttributeValues9, MxEsTap )
{
	MxEsTap object;
...
TEST( getIsMaxOccursUnbounded, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( ctorValue0, MxEsTap )
{
	MxEsTap object( XsString( "" ) );
	std::string expected;
	std::string actual;
	expected = "";
...
TEST( ctorValue2, MxEsTap )
{
	MxEsTap object( XsString( "D,E,F" ) );
	std::string expected;
	std::string actual;
	expected = "D,E,F";
	actual = object.getValue().toString();
...
TEST( ctorValue4, MxEsTap )
{
	MxEsTap object( XsString( "X,Y,Z" ) );
	std::string expected;
	std::string actual;
	expected = "X,Y,Z";
	actual = object.getValue().toString();
...
TEST( getClassName, MxEsTap )
{
	MxEsTap object;
	std::string expected = "MxEsTap";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEsTap )
{
	MxEsTap object;
	std::string expected = "tap";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEsTap )
{
	MxEsTap object;
	std::string expected = "The tap element indicates a tap on the fretboard. The element content allows specification of the notation; + and T are common choices. If empty, the display is application-specific.";
...
TEST( getIsDefaultXRequired0, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsPlacementRequired9, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsPlacementPresent9, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getIsPlacementDefaultDefined, MxEsTap )
{
	MxEsTap object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEsTap )
{
	MxEsTap object;
...
TEST( getDefaultYDefaultValue, MxEsTap )
{
	MxEsTap object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEsTap )
{
	MxEsTap object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEsTap )
{
	MxEsTap object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEsTap )
{
	MxEsTap object;
...
TEST( getFontStyleDefaultValue, MxEsTap )
{
	MxEsTap object;
...
TEST( getFontSizeDefaultValue, MxEsTap )
{
	MxEsTap object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEsTap )
{
	MxEsTap object;
...
TEST( getColorDefaultValue, MxEsTap )
{
	MxEsTap object;
	MxColor expected;
...
TEST( getPlacementDefaultValue, MxEsTap )
{
	MxEsTap object;
...
TEST( toString0, MxEsTap )
{
	...
	object.setIsColorPresent( true );
	object.setIsPlacementPresent( true );
	expected = "<tap default-x=\"303.9\" default-y=\"303.9\" relative-x=\"303.9\" relative-y=\"303.9\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#E0DFDE\" placement=\"above\">D,E,F</tap>";
...
TEST( toString1, MxEsTap )
{
	...
	expected = "<tap default-y=\"304\" relative-x=\"304\" relative-y=\"304\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#E1E2E1E0\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"304.1\" relative-x=\"304.1\" relative-y=\"304.1\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#E4E3E2\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"304.2\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#E5E6E5E4\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"304.3\" default-y=\"304.3\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#E8E7E6\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"304.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#E9EAE9E8\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"304.5\" relative-x=\"304.5\" font-size=\"large\" font-weight=\"normal\" color=\"#ECEBEA\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"304.6\" font-weight=\"bold\" color=\"#EDEEEDEC\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"304.7\" default-y=\"304.7\" relative-x=\"304.7\" relative-y=\"304.7\" color=\"#F0EFEE\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"304.8\" relative-y=\"304.8\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"304.9\" relative-y=\"304.9\" font-family=\"XYZ\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"305\" font-family=\"ABC\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"305.1\" default-y=\"305.1\" relative-x=\"305.1\" font-family=\"DEF\" font-style=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"305.2\" relative-x=\"305.2\" font-family=\"XYZ\" font-style=\"italic\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"305.3\" relative-x=\"305.3\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-style=\"italic\" font-size=\"1.1\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"305.5\" default-y=\"305.5\" relative-y=\"305.5\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"305.6\" relative-y=\"305.6\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"305.7\" relative-x=\"305.7\" relative-y=\"305.7\" font-size=\"large\" font-weight=\"normal\" color=\"#040302\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"305.8\" relative-y=\"305.8\" font-size=\"1.1\" font-weight=\"bold\" color=\"#05060504\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"305.9\" default-y=\"305.9\" relative-x=\"305.9\" font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\" color=\"#080706\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"306\" font-family=\"DEF\" font-weight=\"bold\" color=\"#090A0908\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"306.1\" font-family=\"XYZ\" font-weight=\"normal\" color=\"#0C0B0A\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-family=\"ABC\" font-weight=\"bold\" color=\"#0D0E0D0C\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"306.3\" default-y=\"306.3\" relative-x=\"306.3\" relative-y=\"306.3\" font-family=\"DEF\" font-style=\"normal\" color=\"#100F0E\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"306.4\" relative-x=\"306.4\" relative-y=\"306.4\" font-style=\"italic\" color=\"#11121110\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"306.5\" relative-x=\"306.5\" relative-y=\"306.5\" font-style=\"normal\" color=\"#141312\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"306.6\" font-style=\"italic\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"306.7\" default-y=\"306.7\" font-style=\"normal\" font-size=\"large\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"306.8\" font-style=\"italic\" font-size=\"1.1\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"306.9\" relative-x=\"306.9\" font-family=\"DEF\" font-size=\"large\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"307\" font-family=\"XYZ\" font-size=\"1.1\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"307.1\" default-y=\"307.1\" relative-x=\"307.1\" relative-y=\"307.1\" font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"307.2\" relative-y=\"307.2\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"307.3\" relative-y=\"307.3\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"307.4\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"307.5\" default-y=\"307.5\" relative-x=\"307.5\" font-style=\"normal\" font-weight=\"normal\" color=\"#282726\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"307.6\" relative-x=\"307.6\" font-style=\"italic\" font-weight=\"bold\" color=\"#292A2928\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"307.7\" relative-x=\"307.7\" font-style=\"normal\" font-weight=\"normal\" color=\"#2C2B2A\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-style=\"italic\" font-weight=\"bold\" color=\"#2D2E2D2C\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"307.9\" default-y=\"307.9\" relative-y=\"307.9\" font-family=\"XYZ\" font-style=\"normal\" color=\"#302F2E\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"308\" relative-y=\"308\" font-family=\"ABC\" font-style=\"italic\" color=\"#31323130\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"308.1\" relative-x=\"308.1\" relative-y=\"308.1\" font-family=\"DEF\" font-size=\"large\" color=\"#343332\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"308.2\" relative-y=\"308.2\" font-family=\"XYZ\" font-size=\"1.1\" color=\"#35363534\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"308.3\" default-y=\"308.3\" relative-x=\"308.3\" font-family=\"ABC\" font-size=\"large\" color=\"#383736\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"308.4\" font-size=\"1.1\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"308.5\" font-size=\"large\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-size=\"1.1\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"308.7\" default-y=\"308.7\" relative-x=\"308.7\" relative-y=\"308.7\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"308.8\" relative-x=\"308.8\" relative-y=\"308.8\" font-style=\"italic\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"308.9\" relative-x=\"308.9\" relative-y=\"308.9\" font-family=\"ABC\" font-style=\"normal\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"309\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"309.1\" default-y=\"309.1\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"309.2\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"309.3\" relative-x=\"309.3\" font-family=\"DEF\" font-weight=\"normal\" color=\"#4C4B4A\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"309.4\" font-weight=\"bold\" color=\"#4D4E4D4C\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"309.5\" default-y=\"309.5\" relative-x=\"309.5\" relative-y=\"309.5\" font-size=\"large\" color=\"#504F4E\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"309.6\" relative-y=\"309.6\" font-size=\"1.1\" color=\"#51525150\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"309.7\" relative-y=\"309.7\" font-size=\"large\" color=\"#545352\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"309.8\" font-size=\"1.1\" color=\"#55565554\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"309.9\" default-y=\"309.9\" relative-x=\"309.9\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#585756\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"310\" relative-x=\"310\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#595A5958\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"310.1\" relative-x=\"310.1\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#5C5B5A\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-family=\"DEF\" font-style=\"italic\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"310.3\" default-y=\"310.3\" relative-y=\"310.3\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"310.4\" relative-y=\"310.4\" font-style=\"italic\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"310.5\" relative-x=\"310.5\" relative-y=\"310.5\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"310.6\" relative-y=\"310.6\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"310.7\" default-y=\"310.7\" relative-x=\"310.7\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"310.8\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"310.9\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"311.1\" default-y=\"311.1\" relative-x=\"311.1\" relative-y=\"311.1\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#706F6E\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"311.2\" relative-x=\"311.2\" relative-y=\"311.2\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#71727170\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"311.3\" relative-x=\"311.3\" relative-y=\"311.3\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#747372\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"311.4\" font-style=\"italic\" font-size=\"1.1\" color=\"#75767574\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"311.5\" default-y=\"311.5\" font-style=\"normal\" font-size=\"large\" color=\"#787776\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"311.6\" font-style=\"italic\" color=\"#797A7978\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"311.7\" relative-x=\"311.7\" color=\"#7C7B7A\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"311.8\" color=\"#7D7E7D7C\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"311.9\" default-y=\"311.9\" relative-x=\"311.9\" relative-y=\"311.9\" font-family=\"ABC\" font-weight=\"normal\" color=\"#807F7E\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"312\" relative-y=\"312\" font-family=\"DEF\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"312.1\" relative-y=\"312.1\" font-family=\"XYZ\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"312.2\" font-family=\"ABC\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"312.3\" default-y=\"312.3\" relative-x=\"312.3\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"312.4\" relative-x=\"312.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"312.5\" relative-x=\"312.5\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"312.7\" default-y=\"312.7\" relative-y=\"312.7\" font-style=\"normal\" font-size=\"large\" placement=\"above\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"312.8\" relative-y=\"312.8\" font-style=\"italic\" font-size=\"1.1\" placement=\"below\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"312.9\" relative-x=\"312.9\" relative-y=\"312.9\" font-family=\"DEF\" font-size=\"large\" color=\"#949392\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-x=\"313\" relative-y=\"313\" font-family=\"XYZ\" color=\"#95969594\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"313.1\" default-y=\"313.1\" relative-x=\"313.1\" font-family=\"ABC\" color=\"#989796\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"313.2\" font-family=\"DEF\" color=\"#999A9998\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"313.3\" font-family=\"XYZ\" color=\"#9C9B9A\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap color=\"#9D9E9D9C\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"313.5\" default-y=\"313.5\" relative-x=\"313.5\" relative-y=\"313.5\" font-style=\"normal\" font-weight=\"normal\" color=\"#A09F9E\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap default-y=\"313.6\" relative-x=\"313.6\" relative-y=\"313.6\" font-style=\"italic\" font-weight=\"bold\" color=\"#A1A2A1A0\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<tap default-x=\"313.7\" relative-x=\"313.7\" relative-y=\"313.7\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#A4A3A2\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEsTap )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<tap relative-y=\"313.8\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</tap>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
