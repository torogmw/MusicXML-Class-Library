...
TEST( Ctor, MxEeUnstress )
{
	MxEeUnstress object;
	CHECK( true )
}
TEST( ctorAttributeValues0, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues1, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues5, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues6, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues7, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues8, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( ctorAttributeValues9, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( getMinOccurs, MxEeUnstress )
{
	MxEeUnstress object;
	int expected = 1;
...
TEST( getMaxOccurs, MxEeUnstress )
{
	MxEeUnstress object;
	int expected = 1;
...
TEST( getIsMaxOccursUnbounded, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getClassName, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = "MxEeUnstress";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = "unstress";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEeUnstress )
{
	MxEeUnstress object;
	std::string expected = "The unstress element indicates an unstressed note. It is often notated using a u-shaped symbol.";
...
TEST( setDefaultX0, MxEeUnstress )
{
...
TEST( setDefaultY1, MxEeUnstress )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setRelativeX2, MxEeUnstress )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setRelativeY3, MxEeUnstress )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setFontFamily4, MxEeUnstress )
{
...
TEST( setFontStyle5, MxEeUnstress )
{
...
TEST( setFontSize6, MxEeUnstress )
{
...
TEST( setFontWeight7, MxEeUnstress )
{
...
TEST( setPlacement9, MxEeUnstress )
{
...
TEST( getIsDefaultXRequired0, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsPlacementRequired9, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsPlacementPresent9, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getIsPlacementDefaultDefined, MxEeUnstress )
{
	MxEeUnstress object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( getDefaultYDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( getFontStyleDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( getFontSizeDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( getColorDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
	MxColor expected;
...
TEST( getPlacementDefaultValue, MxEeUnstress )
{
	MxEeUnstress object;
...
TEST( toString0, MxEeUnstress )
{
	...
	object.setIsColorPresent( true );
	object.setIsPlacementPresent( true );
	expected = "<unstress default-x=\"293.9\" default-y=\"293.9\" relative-x=\"293.9\" relative-y=\"293.9\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#21222120\" placement=\"above\"/>";
...
TEST( toString1, MxEeUnstress )
{
	...
	expected = "<unstress default-y=\"294\" relative-x=\"294\" relative-y=\"294\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#242322\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"294.1\" relative-x=\"294.1\" relative-y=\"294.1\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#25262524\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"294.2\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#282726\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"294.3\" default-y=\"294.3\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#292A2928\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"294.4\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#2C2B2A\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"294.5\" relative-x=\"294.5\" font-size=\"1.1\" font-weight=\"bold\" color=\"#2D2E2D2C\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"294.6\" font-weight=\"normal\" color=\"#302F2E\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"294.7\" default-y=\"294.7\" relative-x=\"294.7\" relative-y=\"294.7\" color=\"#31323130\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"294.8\" relative-y=\"294.8\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"294.9\" relative-y=\"294.9\" font-family=\"DEF\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"295\" font-family=\"XYZ\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"295.1\" default-y=\"295.1\" relative-x=\"295.1\" font-family=\"ABC\" font-style=\"italic\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"295.2\" relative-x=\"295.2\" font-family=\"DEF\" font-style=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"295.3\" relative-x=\"295.3\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-style=\"normal\" font-size=\"large\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"295.5\" default-y=\"295.5\" relative-y=\"295.5\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"295.6\" relative-y=\"295.6\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"295.7\" relative-x=\"295.7\" relative-y=\"295.7\" font-size=\"1.1\" font-weight=\"bold\" color=\"#45464544\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"295.8\" relative-y=\"295.8\" font-size=\"large\" font-weight=\"normal\" color=\"#484746\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"295.9\" default-y=\"295.9\" relative-x=\"295.9\" font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\" color=\"#494A4948\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"296\" font-family=\"ABC\" font-weight=\"normal\" color=\"#4C4B4A\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"296.1\" font-family=\"DEF\" font-weight=\"bold\" color=\"#4D4E4D4C\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-family=\"XYZ\" font-weight=\"normal\" color=\"#504F4E\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"296.3\" default-y=\"296.3\" relative-x=\"296.3\" relative-y=\"296.3\" font-family=\"ABC\" font-style=\"italic\" color=\"#51525150\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"296.4\" relative-x=\"296.4\" relative-y=\"296.4\" font-style=\"normal\" color=\"#545352\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"296.5\" relative-x=\"296.5\" relative-y=\"296.5\" font-style=\"italic\" color=\"#55565554\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"296.6\" font-style=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"296.7\" default-y=\"296.7\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"296.8\" font-style=\"normal\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"296.9\" relative-x=\"296.9\" font-family=\"ABC\" font-size=\"1.1\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"297\" font-family=\"DEF\" font-size=\"large\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"297.1\" default-y=\"297.1\" relative-x=\"297.1\" relative-y=\"297.1\" font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"297.2\" relative-y=\"297.2\" font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"297.3\" relative-y=\"297.3\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"297.4\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"297.5\" default-y=\"297.5\" relative-x=\"297.5\" font-style=\"italic\" font-weight=\"bold\" color=\"#696A6968\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"297.6\" relative-x=\"297.6\" font-style=\"normal\" font-weight=\"normal\" color=\"#6C6B6A\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"297.7\" relative-x=\"297.7\" font-style=\"italic\" font-weight=\"bold\" color=\"#6D6E6D6C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-style=\"normal\" font-weight=\"normal\" color=\"#706F6E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"297.9\" default-y=\"297.9\" relative-y=\"297.9\" font-family=\"DEF\" font-style=\"italic\" color=\"#71727170\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"298\" relative-y=\"298\" font-family=\"XYZ\" font-style=\"normal\" color=\"#747372\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"298.1\" relative-x=\"298.1\" relative-y=\"298.1\" font-family=\"ABC\" font-size=\"1.1\" color=\"#75767574\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"298.2\" relative-y=\"298.2\" font-family=\"DEF\" font-size=\"large\" color=\"#787776\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"298.3\" default-y=\"298.3\" relative-x=\"298.3\" font-family=\"XYZ\" font-size=\"1.1\" color=\"#797A7978\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"298.4\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"298.5\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"298.7\" default-y=\"298.7\" relative-x=\"298.7\" relative-y=\"298.7\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"298.8\" relative-x=\"298.8\" relative-y=\"298.8\" font-style=\"normal\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"298.9\" relative-x=\"298.9\" relative-y=\"298.9\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"299\" font-family=\"ABC\" font-style=\"normal\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"299.1\" default-y=\"299.1\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"299.2\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"299.3\" relative-x=\"299.3\" font-family=\"ABC\" font-weight=\"bold\" color=\"#8D8E8D8C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"299.4\" font-weight=\"normal\" color=\"#908F8E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"299.5\" default-y=\"299.5\" relative-x=\"299.5\" relative-y=\"299.5\" font-size=\"1.1\" color=\"#91929190\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"299.6\" relative-y=\"299.6\" font-size=\"large\" color=\"#949392\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"299.7\" relative-y=\"299.7\" font-size=\"1.1\" color=\"#95969594\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"299.8\" font-size=\"large\" color=\"#989796\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"299.9\" default-y=\"299.9\" relative-x=\"299.9\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" color=\"#999A9998\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"300\" relative-x=\"300\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#9C9B9A\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"300.1\" relative-x=\"300.1\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#9D9E9D9C\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-family=\"ABC\" font-style=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"300.3\" default-y=\"300.3\" relative-y=\"300.3\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"300.4\" relative-y=\"300.4\" font-style=\"normal\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"300.5\" relative-x=\"300.5\" relative-y=\"300.5\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"300.6\" relative-y=\"300.6\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"300.7\" default-y=\"300.7\" relative-x=\"300.7\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"300.8\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"300.9\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"301.1\" default-y=\"301.1\" relative-x=\"301.1\" relative-y=\"301.1\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" color=\"#B1B2B1B0\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"301.2\" relative-x=\"301.2\" relative-y=\"301.2\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#B4B3B2\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"301.3\" relative-x=\"301.3\" relative-y=\"301.3\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#B5B6B5B4\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"301.4\" font-style=\"normal\" font-size=\"large\" color=\"#B8B7B6\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"301.5\" default-y=\"301.5\" font-style=\"italic\" font-size=\"1.1\" color=\"#B9BAB9B8\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"301.6\" font-style=\"normal\" color=\"#BCBBBA\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"301.7\" relative-x=\"301.7\" color=\"#BDBEBDBC\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"301.8\" color=\"#C0BFBE\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"301.9\" default-y=\"301.9\" relative-x=\"301.9\" relative-y=\"301.9\" font-family=\"XYZ\" font-weight=\"bold\" color=\"#C1C2C1C0\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"302\" relative-y=\"302\" font-family=\"ABC\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"302.1\" relative-y=\"302.1\" font-family=\"DEF\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"302.2\" font-family=\"XYZ\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"302.3\" default-y=\"302.3\" relative-x=\"302.3\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"302.4\" relative-x=\"302.4\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"302.5\" relative-x=\"302.5\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"302.7\" default-y=\"302.7\" relative-y=\"302.7\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"302.8\" relative-y=\"302.8\" font-style=\"normal\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"302.9\" relative-x=\"302.9\" relative-y=\"302.9\" font-family=\"ABC\" font-size=\"1.1\" color=\"#D5D6D5D4\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-x=\"303\" relative-y=\"303\" font-family=\"DEF\" color=\"#D8D7D6\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"303.1\" default-y=\"303.1\" relative-x=\"303.1\" font-family=\"XYZ\" color=\"#D9DAD9D8\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"303.2\" font-family=\"ABC\" color=\"#DCDBDA\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"303.3\" font-family=\"DEF\" color=\"#DDDEDDDC\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress color=\"#E0DFDE\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"303.5\" default-y=\"303.5\" relative-x=\"303.5\" relative-y=\"303.5\" font-style=\"italic\" font-weight=\"bold\" color=\"#E1E2E1E0\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress default-y=\"303.6\" relative-x=\"303.6\" relative-y=\"303.6\" font-style=\"normal\" font-weight=\"normal\" color=\"#E4E3E2\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<unstress default-x=\"303.7\" relative-x=\"303.7\" relative-y=\"303.7\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#E5E6E5E4\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEeUnstress )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<unstress relative-y=\"303.8\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
