...
TEST( Ctor, MxEeSpiccato )
{
	MxEeSpiccato object;
	CHECK( true )
}
TEST( ctorAttributeValues0, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues1, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues5, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues6, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues7, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues8, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( ctorAttributeValues9, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( getMinOccurs, MxEeSpiccato )
{
	MxEeSpiccato object;
	int expected = 1;
...
TEST( getMaxOccurs, MxEeSpiccato )
{
	MxEeSpiccato object;
	int expected = 1;
...
TEST( getIsMaxOccursUnbounded, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getClassName, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = "MxEeSpiccato";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = "spiccato";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEeSpiccato )
{
	MxEeSpiccato object;
	std::string expected = "The spiccato element is used for a stroke articulation, as opposed to a dot or a wedge.";
...
TEST( setDefaultX0, MxEeSpiccato )
{
...
TEST( setDefaultY1, MxEeSpiccato )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setRelativeX2, MxEeSpiccato )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setRelativeY3, MxEeSpiccato )
{
	MxNumberTenths value1( 0.1 );
	MxNumberTenths value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setFontFamily4, MxEeSpiccato )
{
...
TEST( setFontStyle5, MxEeSpiccato )
{
...
TEST( setFontSize6, MxEeSpiccato )
{
...
TEST( setFontWeight7, MxEeSpiccato )
{
...
TEST( setPlacement9, MxEeSpiccato )
{
...
TEST( getIsDefaultXRequired0, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsPlacementRequired9, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsPlacementPresent9, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getIsPlacementDefaultDefined, MxEeSpiccato )
{
	MxEeSpiccato object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( getDefaultYDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( getFontStyleDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( getFontSizeDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( getColorDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
	MxColor expected;
...
TEST( getPlacementDefaultValue, MxEeSpiccato )
{
	MxEeSpiccato object;
...
TEST( toString0, MxEeSpiccato )
{
	...
	object.setIsColorPresent( true );
	object.setIsPlacementPresent( true );
	expected = "<spiccato default-x=\"223.2\" default-y=\"223.2\" relative-x=\"223.2\" relative-y=\"223.2\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#9C9B9A\" placement=\"below\"/>";
...
TEST( toString1, MxEeSpiccato )
{
	...
	expected = "<spiccato default-y=\"223.3\" relative-x=\"223.3\" relative-y=\"223.3\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#9D9E9D9C\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"223.4\" relative-x=\"223.4\" relative-y=\"223.4\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#A09F9E\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"223.5\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#A1A2A1A0\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"223.6\" default-y=\"223.6\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#A4A3A2\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"223.7\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#A5A6A5A4\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"223.8\" relative-x=\"223.8\" font-size=\"large\" font-weight=\"normal\" color=\"#A8A7A6\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"223.9\" font-weight=\"bold\" color=\"#A9AAA9A8\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"224\" default-y=\"224\" relative-x=\"224\" relative-y=\"224\" color=\"#ACABAA\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"224.1\" relative-y=\"224.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"224.2\" relative-y=\"224.2\" font-family=\"XYZ\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"224.3\" font-family=\"ABC\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"224.4\" default-y=\"224.4\" relative-x=\"224.4\" font-family=\"DEF\" font-style=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"224.5\" relative-x=\"224.5\" font-family=\"XYZ\" font-style=\"italic\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"224.6\" relative-x=\"224.6\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-style=\"italic\" font-size=\"1.1\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"224.8\" default-y=\"224.8\" relative-y=\"224.8\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"224.9\" relative-y=\"224.9\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"225\" relative-x=\"225\" relative-y=\"225\" font-size=\"large\" font-weight=\"normal\" color=\"#C0BFBE\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"225.1\" relative-y=\"225.1\" font-size=\"1.1\" font-weight=\"bold\" color=\"#C1C2C1C0\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"225.2\" default-y=\"225.2\" relative-x=\"225.2\" font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\" color=\"#C4C3C2\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"225.3\" font-family=\"DEF\" font-weight=\"bold\" color=\"#C5C6C5C4\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"225.4\" font-family=\"XYZ\" font-weight=\"normal\" color=\"#C8C7C6\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-family=\"ABC\" font-weight=\"bold\" color=\"#C9CAC9C8\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"225.6\" default-y=\"225.6\" relative-x=\"225.6\" relative-y=\"225.6\" font-family=\"DEF\" font-style=\"normal\" color=\"#CCCBCA\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"225.7\" relative-x=\"225.7\" relative-y=\"225.7\" font-style=\"italic\" color=\"#CDCECDCC\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"225.8\" relative-x=\"225.8\" relative-y=\"225.8\" font-style=\"normal\" color=\"#D0CFCE\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"225.9\" font-style=\"italic\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"226\" default-y=\"226\" font-style=\"normal\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"226.1\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"226.2\" relative-x=\"226.2\" font-family=\"DEF\" font-size=\"large\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"226.3\" font-family=\"XYZ\" font-size=\"1.1\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"226.4\" default-y=\"226.4\" relative-x=\"226.4\" relative-y=\"226.4\" font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"226.5\" relative-y=\"226.5\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"226.6\" relative-y=\"226.6\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"226.7\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"226.8\" default-y=\"226.8\" relative-x=\"226.8\" font-style=\"normal\" font-weight=\"normal\" color=\"#E4E3E2\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"226.9\" relative-x=\"226.9\" font-style=\"italic\" font-weight=\"bold\" color=\"#E5E6E5E4\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"227\" relative-x=\"227\" font-style=\"normal\" font-weight=\"normal\" color=\"#E8E7E6\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-style=\"italic\" font-weight=\"bold\" color=\"#E9EAE9E8\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"227.2\" default-y=\"227.2\" relative-y=\"227.2\" font-family=\"XYZ\" font-style=\"normal\" color=\"#ECEBEA\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"227.3\" relative-y=\"227.3\" font-family=\"ABC\" font-style=\"italic\" color=\"#EDEEEDEC\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"227.4\" relative-x=\"227.4\" relative-y=\"227.4\" font-family=\"DEF\" font-size=\"large\" color=\"#F0EFEE\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"227.5\" relative-y=\"227.5\" font-family=\"XYZ\" font-size=\"1.1\" color=\"#F1F2F1F0\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"227.6\" default-y=\"227.6\" relative-x=\"227.6\" font-family=\"ABC\" font-size=\"large\" color=\"#F4F3F2\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"227.7\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"227.8\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"228\" default-y=\"228\" relative-x=\"228\" relative-y=\"228\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"228.1\" relative-x=\"228.1\" relative-y=\"228.1\" font-style=\"italic\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"228.2\" relative-x=\"228.2\" relative-y=\"228.2\" font-family=\"ABC\" font-style=\"normal\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"228.3\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"228.4\" default-y=\"228.4\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"228.5\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"228.6\" relative-x=\"228.6\" font-family=\"DEF\" font-weight=\"normal\" color=\"#080706\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"228.7\" font-weight=\"bold\" color=\"#090A0908\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"228.8\" default-y=\"228.8\" relative-x=\"228.8\" relative-y=\"228.8\" font-size=\"large\" color=\"#0C0B0A\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"228.9\" relative-y=\"228.9\" font-size=\"1.1\" color=\"#0D0E0D0C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"229\" relative-y=\"229\" font-size=\"large\" color=\"#100F0E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"229.1\" font-size=\"1.1\" color=\"#11121110\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"229.2\" default-y=\"229.2\" relative-x=\"229.2\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#141312\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"229.3\" relative-x=\"229.3\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#15161514\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"229.4\" relative-x=\"229.4\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#181716\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-family=\"DEF\" font-style=\"italic\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"229.6\" default-y=\"229.6\" relative-y=\"229.6\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"229.7\" relative-y=\"229.7\" font-style=\"italic\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"229.8\" relative-x=\"229.8\" relative-y=\"229.8\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"229.9\" relative-y=\"229.9\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"230\" default-y=\"230\" relative-x=\"230\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"230.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"230.2\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"230.4\" default-y=\"230.4\" relative-x=\"230.4\" relative-y=\"230.4\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#2C2B2A\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"230.5\" relative-x=\"230.5\" relative-y=\"230.5\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" color=\"#2D2E2D2C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"230.6\" relative-x=\"230.6\" relative-y=\"230.6\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#302F2E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"230.7\" font-style=\"italic\" font-size=\"1.1\" color=\"#31323130\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"230.8\" default-y=\"230.8\" font-style=\"normal\" font-size=\"large\" color=\"#343332\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"230.9\" font-style=\"italic\" color=\"#35363534\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"231\" relative-x=\"231\" color=\"#383736\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"231.1\" color=\"#393A3938\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"231.2\" default-y=\"231.2\" relative-x=\"231.2\" relative-y=\"231.2\" font-family=\"ABC\" font-weight=\"normal\" color=\"#3C3B3A\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"231.3\" relative-y=\"231.3\" font-family=\"DEF\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"231.4\" relative-y=\"231.4\" font-family=\"XYZ\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"231.5\" font-family=\"ABC\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"231.6\" default-y=\"231.6\" relative-x=\"231.6\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"231.7\" relative-x=\"231.7\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"231.8\" relative-x=\"231.8\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"232\" default-y=\"232\" relative-y=\"232\" font-style=\"normal\" font-size=\"large\" placement=\"below\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"232.1\" relative-y=\"232.1\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"232.2\" relative-x=\"232.2\" relative-y=\"232.2\" font-family=\"DEF\" font-size=\"large\" color=\"#504F4E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-x=\"232.3\" relative-y=\"232.3\" font-family=\"XYZ\" color=\"#51525150\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"232.4\" default-y=\"232.4\" relative-x=\"232.4\" font-family=\"ABC\" color=\"#545352\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"232.5\" font-family=\"DEF\" color=\"#55565554\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"232.6\" font-family=\"XYZ\" color=\"#585756\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato color=\"#595A5958\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"232.8\" default-y=\"232.8\" relative-x=\"232.8\" relative-y=\"232.8\" font-style=\"normal\" font-weight=\"normal\" color=\"#5C5B5A\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato default-y=\"232.9\" relative-x=\"232.9\" relative-y=\"232.9\" font-style=\"italic\" font-weight=\"bold\" color=\"#5D5E5D5C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<spiccato default-x=\"233\" relative-x=\"233\" relative-y=\"233\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#605F5E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEeSpiccato )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<spiccato relative-y=\"233.1\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
