...
TEST( ctorAttributeValues0, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues1, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues5, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues6, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues7, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues8, MxEsPluck )
{
	MxEsPluck object;
...
TEST( ctorAttributeValues9, MxEsPluck )
{
	MxEsPluck object;
...
TEST( getIsMaxOccursUnbounded, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( ctorValue0, MxEsPluck )
{
	MxEsPluck object( XsString( "" ) );
	std::string expected;
	std::string actual;
	expected = "";
...
TEST( ctorValue2, MxEsPluck )
{
	MxEsPluck object( XsString( "D,E,F" ) );
	std::string expected;
	std::string actual;
	expected = "D,E,F";
	actual = object.getValue().toString();
...
TEST( ctorValue4, MxEsPluck )
{
	MxEsPluck object( XsString( "X,Y,Z" ) );
	std::string expected;
	std::string actual;
	expected = "X,Y,Z";
	actual = object.getValue().toString();
...
TEST( getClassName, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = "MxEsPluck";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = "pluck";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEsPluck )
{
	MxEsPluck object;
	std::string expected = "The pluck element is used to specify the plucking fingering on a fretted instrument, where the fingering element refers to the fretting fingering. Typical values are p, i, m, a for pulgar/thumb, indicio/index, medio/middle, and anular/ring fingers.";
...
TEST( getIsDefaultXRequired0, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsPlacementRequired9, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsPlacementPresent9, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getIsPlacementDefaultDefined, MxEsPluck )
{
	MxEsPluck object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEsPluck )
{
	MxEsPluck object;
...
TEST( getDefaultYDefaultValue, MxEsPluck )
{
	MxEsPluck object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEsPluck )
{
	MxEsPluck object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEsPluck )
{
	MxEsPluck object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEsPluck )
{
	MxEsPluck object;
...
TEST( getFontStyleDefaultValue, MxEsPluck )
{
	MxEsPluck object;
...
TEST( getFontSizeDefaultValue, MxEsPluck )
{
	MxEsPluck object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEsPluck )
{
	MxEsPluck object;
...
TEST( getColorDefaultValue, MxEsPluck )
{
	MxEsPluck object;
	MxColor expected;
...
TEST( getPlacementDefaultValue, MxEsPluck )
{
	MxEsPluck object;
...
TEST( toString0, MxEsPluck )
{
	...
	object.setIsColorPresent( true );
	object.setIsPlacementPresent( true );
	expected = "<pluck default-x=\"263.5\" default-y=\"263.5\" relative-x=\"263.5\" relative-y=\"263.5\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#797A7978\" placement=\"above\">D,E,F</pluck>";
...
TEST( toString1, MxEsPluck )
{
	...
	expected = "<pluck default-y=\"263.6\" relative-x=\"263.6\" relative-y=\"263.6\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#7C7B7A\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"263.7\" relative-x=\"263.7\" relative-y=\"263.7\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#7D7E7D7C\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"263.8\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#807F7E\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"263.9\" default-y=\"263.9\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#81828180\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"264\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#848382\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"264.1\" relative-x=\"264.1\" font-size=\"1.1\" font-weight=\"bold\" color=\"#85868584\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"264.2\" font-weight=\"normal\" color=\"#888786\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"264.3\" default-y=\"264.3\" relative-x=\"264.3\" relative-y=\"264.3\" color=\"#898A8988\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"264.4\" relative-y=\"264.4\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"264.5\" relative-y=\"264.5\" font-family=\"XYZ\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"264.6\" font-family=\"ABC\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"264.7\" default-y=\"264.7\" relative-x=\"264.7\" font-family=\"DEF\" font-style=\"italic\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"264.8\" relative-x=\"264.8\" font-family=\"XYZ\" font-style=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"264.9\" relative-x=\"264.9\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-style=\"normal\" font-size=\"large\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"265.1\" default-y=\"265.1\" relative-y=\"265.1\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"265.2\" relative-y=\"265.2\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"265.3\" relative-x=\"265.3\" relative-y=\"265.3\" font-size=\"1.1\" font-weight=\"bold\" color=\"#9D9E9D9C\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"265.4\" relative-y=\"265.4\" font-size=\"large\" font-weight=\"normal\" color=\"#A09F9E\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"265.5\" default-y=\"265.5\" relative-x=\"265.5\" font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\" color=\"#A1A2A1A0\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"265.6\" font-family=\"DEF\" font-weight=\"normal\" color=\"#A4A3A2\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"265.7\" font-family=\"XYZ\" font-weight=\"bold\" color=\"#A5A6A5A4\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-family=\"ABC\" font-weight=\"normal\" color=\"#A8A7A6\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"265.9\" default-y=\"265.9\" relative-x=\"265.9\" relative-y=\"265.9\" font-family=\"DEF\" font-style=\"italic\" color=\"#A9AAA9A8\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"266\" relative-x=\"266\" relative-y=\"266\" font-style=\"normal\" color=\"#ACABAA\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"266.1\" relative-x=\"266.1\" relative-y=\"266.1\" font-style=\"italic\" color=\"#ADAEADAC\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"266.2\" font-style=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"266.3\" default-y=\"266.3\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"266.4\" font-style=\"normal\" font-size=\"large\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"266.5\" relative-x=\"266.5\" font-family=\"DEF\" font-size=\"1.1\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"266.6\" font-family=\"XYZ\" font-size=\"large\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"266.7\" default-y=\"266.7\" relative-x=\"266.7\" relative-y=\"266.7\" font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"266.8\" relative-y=\"266.8\" font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"266.9\" relative-y=\"266.9\" font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"267\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"267.1\" default-y=\"267.1\" relative-x=\"267.1\" font-style=\"italic\" font-weight=\"bold\" color=\"#C1C2C1C0\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"267.2\" relative-x=\"267.2\" font-style=\"normal\" font-weight=\"normal\" color=\"#C4C3C2\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"267.3\" relative-x=\"267.3\" font-style=\"italic\" font-weight=\"bold\" color=\"#C5C6C5C4\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-style=\"normal\" font-weight=\"normal\" color=\"#C8C7C6\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"267.5\" default-y=\"267.5\" relative-y=\"267.5\" font-family=\"XYZ\" font-style=\"italic\" color=\"#C9CAC9C8\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"267.6\" relative-y=\"267.6\" font-family=\"ABC\" font-style=\"normal\" color=\"#CCCBCA\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"267.7\" relative-x=\"267.7\" relative-y=\"267.7\" font-family=\"DEF\" font-size=\"1.1\" color=\"#CDCECDCC\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"267.8\" relative-y=\"267.8\" font-family=\"XYZ\" font-size=\"large\" color=\"#D0CFCE\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"267.9\" default-y=\"267.9\" relative-x=\"267.9\" font-family=\"ABC\" font-size=\"1.1\" color=\"#D1D2D1D0\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"268\" font-size=\"large\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"268.1\" font-size=\"1.1\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-size=\"large\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"268.3\" default-y=\"268.3\" relative-x=\"268.3\" relative-y=\"268.3\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"268.4\" relative-x=\"268.4\" relative-y=\"268.4\" font-style=\"normal\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"268.5\" relative-x=\"268.5\" relative-y=\"268.5\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"268.6\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"268.7\" default-y=\"268.7\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"268.8\" font-family=\"ABC\" font-style=\"normal\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"268.9\" relative-x=\"268.9\" font-family=\"DEF\" font-weight=\"bold\" color=\"#E5E6E5E4\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"269\" font-weight=\"normal\" color=\"#E8E7E6\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"269.1\" default-y=\"269.1\" relative-x=\"269.1\" relative-y=\"269.1\" font-size=\"1.1\" color=\"#E9EAE9E8\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"269.2\" relative-y=\"269.2\" font-size=\"large\" color=\"#ECEBEA\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"269.3\" relative-y=\"269.3\" font-size=\"1.1\" color=\"#EDEEEDEC\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"269.4\" font-size=\"large\" color=\"#F0EFEE\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"269.5\" default-y=\"269.5\" relative-x=\"269.5\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#F1F2F1F0\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"269.6\" relative-x=\"269.6\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#F4F3F2\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"269.7\" relative-x=\"269.7\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" color=\"#F5F6F5F4\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-family=\"DEF\" font-style=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"269.9\" default-y=\"269.9\" relative-y=\"269.9\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"270\" relative-y=\"270\" font-style=\"normal\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"270.1\" relative-x=\"270.1\" relative-y=\"270.1\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"270.2\" relative-y=\"270.2\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"270.3\" default-y=\"270.3\" relative-x=\"270.3\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"270.4\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"270.5\" font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-family=\"ABC\" font-size=\"large\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"270.7\" default-y=\"270.7\" relative-x=\"270.7\" relative-y=\"270.7\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#090A0908\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"270.8\" relative-x=\"270.8\" relative-y=\"270.8\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#0C0B0A\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"270.9\" relative-x=\"270.9\" relative-y=\"270.9\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" color=\"#0D0E0D0C\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"271\" font-style=\"normal\" font-size=\"large\" color=\"#100F0E\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"271.1\" default-y=\"271.1\" font-style=\"italic\" font-size=\"1.1\" color=\"#11121110\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"271.2\" font-style=\"normal\" color=\"#141312\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"271.3\" relative-x=\"271.3\" color=\"#15161514\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"271.4\" color=\"#181716\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"271.5\" default-y=\"271.5\" relative-x=\"271.5\" relative-y=\"271.5\" font-family=\"ABC\" font-weight=\"bold\" color=\"#191A1918\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"271.6\" relative-y=\"271.6\" font-family=\"DEF\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"271.7\" relative-y=\"271.7\" font-family=\"XYZ\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"271.8\" font-family=\"ABC\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"271.9\" default-y=\"271.9\" relative-x=\"271.9\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"272\" relative-x=\"272\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"272.1\" relative-x=\"272.1\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"272.3\" default-y=\"272.3\" relative-y=\"272.3\" font-style=\"italic\" font-size=\"1.1\" placement=\"above\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"272.4\" relative-y=\"272.4\" font-style=\"normal\" font-size=\"large\" placement=\"below\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"272.5\" relative-x=\"272.5\" relative-y=\"272.5\" font-family=\"DEF\" font-size=\"1.1\" color=\"#2D2E2D2C\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-x=\"272.6\" relative-y=\"272.6\" font-family=\"XYZ\" color=\"#302F2E\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"272.7\" default-y=\"272.7\" relative-x=\"272.7\" font-family=\"ABC\" color=\"#31323130\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"272.8\" font-family=\"DEF\" color=\"#343332\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"272.9\" font-family=\"XYZ\" color=\"#35363534\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck color=\"#383736\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"273.1\" default-y=\"273.1\" relative-x=\"273.1\" relative-y=\"273.1\" font-style=\"italic\" font-weight=\"bold\" color=\"#393A3938\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck default-y=\"273.2\" relative-x=\"273.2\" relative-y=\"273.2\" font-style=\"normal\" font-weight=\"normal\" color=\"#3C3B3A\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::above ) );
	expected = "<pluck default-x=\"273.3\" relative-x=\"273.3\" relative-y=\"273.3\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#3D3E3D3C\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEsPluck )
{
	...
	object.setPlacement( MxEnumAboveBelow( lexicon::enums::AboveBelow::below ) );
	expected = "<pluck relative-y=\"273.4\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</pluck>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
