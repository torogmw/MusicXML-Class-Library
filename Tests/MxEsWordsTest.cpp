...
TEST( ctorAttributeValues0, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues1, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues2, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues5, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues6, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues7, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues8, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues9, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues10, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxEnumLeftCenterRight(  ) ).toString();
...
TEST( ctorAttributeValues11, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues12, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues13, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxNumberNumberOfLines(  ) ).toString();
...
TEST( ctorAttributeValues14, MxEsWords )
{
	MxEsWords object;
	std::string expected = ( MxNumberNumberOfLines(  ) ).toString();
...
TEST( ctorAttributeValues15, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues16, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues17, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues18, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues19, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues20, MxEsWords )
{
	MxEsWords object;
...
TEST( ctorAttributeValues21, MxEsWords )
{
	MxEsWords object;
...
TEST( getIsMaxOccursUnbounded, MxEsWords )
{
	MxEsWords object;
	bool expected = true;
...
TEST( ctorValue0, MxEsWords )
{
	MxEsWords object( XsString( "" ) );
	std::string expected;
	std::string actual;
	expected = "";
...
TEST( ctorValue2, MxEsWords )
{
	MxEsWords object( XsString( "D,E,F" ) );
	std::string expected;
	std::string actual;
	expected = "D,E,F";
	actual = object.getValue().toString();
...
TEST( ctorValue4, MxEsWords )
{
	MxEsWords object( XsString( "X,Y,Z" ) );
	std::string expected;
	std::string actual;
	expected = "X,Y,Z";
	actual = object.getValue().toString();
...
TEST( getClassName, MxEsWords )
{
	MxEsWords object;
	std::string expected = "MxEsWords";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEsWords )
{
	MxEsWords object;
	std::string expected = "words";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEsWords )
{
	MxEsWords object;
	std::string expected = "The words element specifies a standard text direction. Left justification is assumed if not specified. Language is Italian ('it') by default. Enclosure is none by default.";
...
TEST( setLineThrough14, MxEsWords )
{
	MxNumberNumberOfLines value1( 1 );
	MxNumberNumberOfLines value2( 2 );
	CHECK( ( value1 != value2 ) )
...
TEST( setLetterSpacing16, MxEsWords )
{
...
TEST( setLineHeight17, MxEsWords )
{
	MxNumberOrNormal value1( 0.1 );
	MxNumberOrNormal value2( 0.2 );
	CHECK( ( value1 != value2 ) )
...
TEST( getIsJustifyRequired0, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultXRequired1, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultYRequired2, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeXRequired3, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeYRequired4, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired5, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontStyleRequired6, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontSizeRequired7, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontWeightRequired8, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsColorRequired9, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsHalignRequired10, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsValignRequired11, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsUnderlineRequired12, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsOverlineRequired13, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLineThroughRequired14, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRotationRequired15, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLetterSpacingRequired16, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLineHeightRequired17, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlLangRequired18, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlSpaceRequired19, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDirRequired20, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsEnclosureRequired21, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsJustifyPresent0, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultXPresent1, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultYPresent2, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeXPresent3, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeYPresent4, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent5, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontStylePresent6, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontSizePresent7, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontWeightPresent8, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsColorPresent9, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsHalignPresent10, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsValignPresent11, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsUnderlinePresent12, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsOverlinePresent13, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLineThroughPresent14, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRotationPresent15, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLetterSpacingPresent16, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLineHeightPresent17, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlLangPresent18, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlSpacePresent19, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDirPresent20, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsEnclosurePresent21, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsJustifyDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsHalignDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsValignDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsUnderlineDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsOverlineDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLineThroughDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsRotationDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsLetterSpacingDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = true;
...
TEST( getIsLineHeightDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlLangDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsXmlSpaceDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsDirDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getIsEnclosureDefaultDefined, MxEsWords )
{
	MxEsWords object;
	bool expected = false;
...
TEST( getJustifyDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getDefaultXDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getDefaultYDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getFontStyleDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getFontSizeDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getColorDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxColor expected;
...
TEST( getHalignDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxEnumLeftCenterRight expected;
...
TEST( getValignDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getUnderlineDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getOverlineDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxNumberNumberOfLines expected;
...
TEST( getLineThroughDefaultValue, MxEsWords )
{
	MxEsWords object;
	MxNumberNumberOfLines expected;
...
TEST( getRotationDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getLetterSpacingDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getLineHeightDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getXmlLangDefaultValue, MxEsWords )
{
	MxEsWords object;
	XmlLang expected;
...
TEST( getXmlSpaceDefaultValue, MxEsWords )
{
	MxEsWords object;
	XmlSpace expected;
...
TEST( getDirDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( getEnclosureDefaultValue, MxEsWords )
{
	MxEsWords object;
...
TEST( toString0, MxEsWords )
{
	...
	object.setIsDirPresent( true );
	object.setIsEnclosurePresent( true );
	expected = "<words justify=\"left\" default-x=\"91.8\" default-y=\"91.8\" relative-x=\"91.8\" relative-y=\"91.8\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#1C1B1A\" halign=\"left\" valign=\"bottom\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"11.2\" letter-spacing=\"10.2\" line-height=\"10.2\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
...
TEST( toString1, MxEsWords )
{
	...
	expected = "<words default-x=\"91.9\" default-y=\"91.9\" relative-x=\"91.9\" relative-y=\"91.9\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#1D1E1D1C\" halign=\"center\" valign=\"baseline\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"11.3\" letter-spacing=\"10.3\" line-height=\"10.3\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEsWords )
{
	...
	expected = "<words justify=\"right\" default-y=\"92\" relative-x=\"92\" relative-y=\"92\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#201F1E\" halign=\"right\" valign=\"top\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"11.4\" letter-spacing=\"10.4\" line-height=\"10.4\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEsWords )
{
	...
	expected = "<words relative-x=\"92.1\" relative-y=\"92.1\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#21222120\" halign=\"left\" valign=\"middle\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"11.5\" letter-spacing=\"10.5\" line-height=\"10.5\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEsWords )
{
	...
	expected = "<words justify=\"center\" default-x=\"92.2\" relative-y=\"92.2\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#242322\" halign=\"center\" valign=\"bottom\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"11.6\" letter-spacing=\"10.6\" line-height=\"10.6\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEsWords )
{
	...
	expected = "<words default-x=\"92.3\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#25262524\" halign=\"right\" valign=\"baseline\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"11.7\" letter-spacing=\"10.7\" line-height=\"10.7\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEsWords )
{
	...
	expected = "<words justify=\"left\" default-y=\"92.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#282726\" halign=\"left\" valign=\"top\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"11.8\" letter-spacing=\"10.8\" line-height=\"10.8\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEsWords )
{
	...
	expected = "<words default-y=\"92.5\" font-size=\"large\" font-weight=\"normal\" color=\"#292A2928\" halign=\"center\" valign=\"middle\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"11.9\" letter-spacing=\"10.9\" line-height=\"10.9\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"right\" default-x=\"92.6\" default-y=\"92.6\" relative-x=\"92.6\" font-weight=\"bold\" color=\"#2C2B2A\" halign=\"right\" valign=\"bottom\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"12\" letter-spacing=\"11\" line-height=\"11\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"92.7\" relative-x=\"92.7\" color=\"#2D2E2D2C\" halign=\"left\" valign=\"baseline\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"12.1\" letter-spacing=\"11.1\" line-height=\"11.1\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"center\" relative-x=\"92.8\" relative-y=\"92.8\" halign=\"center\" valign=\"top\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"12.2\" letter-spacing=\"11.2\" line-height=\"11.2\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"92.9\" relative-y=\"92.9\" valign=\"middle\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"12.3\" letter-spacing=\"11.3\" line-height=\"11.3\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"left\" default-x=\"93\" default-y=\"93\" relative-y=\"93\" font-family=\"DEF\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"12.4\" letter-spacing=\"11.4\" line-height=\"11.4\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"93.1\" default-y=\"93.1\" relative-y=\"93.1\" font-family=\"XYZ\" overline=\"2\" line-through=\"2\" rotation=\"12.5\" letter-spacing=\"11.5\" line-height=\"11.5\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"right\" default-y=\"93.2\" relative-y=\"93.2\" font-family=\"ABC\" font-style=\"italic\" line-through=\"0\" rotation=\"12.6\" letter-spacing=\"11.6\" line-height=\"11.6\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words font-family=\"DEF\" font-style=\"normal\" rotation=\"12.7\" letter-spacing=\"11.7\" line-height=\"11.7\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"center\" default-x=\"93.4\" relative-x=\"93.4\" font-family=\"XYZ\" font-style=\"italic\" font-size=\"1.1\" letter-spacing=\"11.8\" line-height=\"11.8\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"93.5\" relative-x=\"93.5\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" line-height=\"11.9\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"left\" default-y=\"93.6\" relative-x=\"93.6\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words default-y=\"93.7\" relative-x=\"93.7\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"right\" default-x=\"93.8\" default-y=\"93.8\" relative-y=\"93.8\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#444342\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"93.9\" relative-y=\"93.9\" font-size=\"large\" font-weight=\"normal\" color=\"#45464544\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"center\" relative-y=\"94\" font-size=\"1.1\" font-weight=\"bold\" color=\"#484746\" halign=\"center\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words relative-y=\"94.1\" font-size=\"large\" font-weight=\"normal\" color=\"#494A4948\" halign=\"right\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"left\" default-x=\"94.2\" default-y=\"94.2\" relative-x=\"94.2\" relative-y=\"94.2\" font-family=\"DEF\" font-weight=\"bold\" color=\"#4C4B4A\" halign=\"left\" valign=\"bottom\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"94.3\" default-y=\"94.3\" relative-x=\"94.3\" font-family=\"XYZ\" font-weight=\"normal\" color=\"#4D4E4D4C\" halign=\"center\" valign=\"baseline\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"right\" default-y=\"94.4\" relative-x=\"94.4\" font-family=\"ABC\" font-weight=\"bold\" color=\"#504F4E\" halign=\"right\" valign=\"top\" underline=\"0\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"94.5\" font-family=\"DEF\" color=\"#51525150\" halign=\"left\" valign=\"middle\" underline=\"1\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"center\" default-x=\"94.6\" font-family=\"XYZ\" font-style=\"italic\" color=\"#545352\" halign=\"center\" valign=\"bottom\" underline=\"2\" overline=\"2\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"94.7\" font-family=\"ABC\" font-style=\"normal\" color=\"#55565554\" halign=\"right\" valign=\"baseline\" underline=\"0\" overline=\"0\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"left\" default-y=\"94.8\" relative-y=\"94.8\" font-style=\"italic\" halign=\"left\" valign=\"top\" underline=\"1\" overline=\"1\" line-through=\"1\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words default-y=\"94.9\" relative-y=\"94.9\" font-style=\"normal\" halign=\"center\" valign=\"middle\" underline=\"2\" overline=\"2\" line-through=\"2\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"right\" default-x=\"95\" default-y=\"95\" relative-x=\"95\" relative-y=\"95\" font-style=\"italic\" font-size=\"1.1\" halign=\"right\" valign=\"bottom\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"14.4\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"95.1\" relative-x=\"95.1\" relative-y=\"95.1\" font-style=\"normal\" font-size=\"large\" valign=\"baseline\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"14.5\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"center\" relative-x=\"95.2\" relative-y=\"95.2\" font-style=\"italic\" font-size=\"1.1\" valign=\"top\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"14.6\" letter-spacing=\"13.6\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"95.3\" font-size=\"large\" valign=\"middle\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"14.7\" letter-spacing=\"13.7\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"left\" default-x=\"95.4\" default-y=\"95.4\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\" underline=\"1\" overline=\"1\" line-through=\"1\" rotation=\"14.8\" letter-spacing=\"13.8\" line-height=\"13.8\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"95.5\" default-y=\"95.5\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"14.9\" letter-spacing=\"13.9\" line-height=\"13.9\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"right\" default-y=\"95.6\" font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\" underline=\"0\" overline=\"0\" line-through=\"0\" rotation=\"15\" letter-spacing=\"14\" line-height=\"14\" xml:lang=\"DEF\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\" overline=\"1\" line-through=\"1\" rotation=\"15.1\" letter-spacing=\"14.1\" line-height=\"14.1\" xml:lang=\"XYZ\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"center\" default-x=\"95.8\" relative-x=\"95.8\" relative-y=\"95.8\" font-family=\"XYZ\" font-weight=\"bold\" color=\"#6C6B6A\" overline=\"2\" line-through=\"2\" rotation=\"15.2\" letter-spacing=\"14.2\" line-height=\"14.2\" xml:lang=\"ABC\" xml:space=\"default\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"95.9\" relative-x=\"95.9\" relative-y=\"95.9\" font-family=\"ABC\" font-weight=\"normal\" color=\"#6D6E6D6C\" overline=\"0\" line-through=\"0\" rotation=\"15.3\" letter-spacing=\"14.3\" line-height=\"14.3\" xml:lang=\"DEF\" xml:space=\"preserve\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"left\" default-y=\"96\" relative-x=\"96\" relative-y=\"96\" font-style=\"italic\" font-weight=\"bold\" color=\"#706F6E\" line-through=\"1\" rotation=\"15.4\" letter-spacing=\"14.4\" line-height=\"14.4\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"ltr\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words default-y=\"96.1\" relative-x=\"96.1\" relative-y=\"96.1\" font-style=\"normal\" font-weight=\"normal\" color=\"#71727170\" line-through=\"2\" rotation=\"15.5\" letter-spacing=\"14.5\" line-height=\"14.5\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rtl\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"right\" default-x=\"96.2\" default-y=\"96.2\" relative-y=\"96.2\" font-style=\"italic\" font-weight=\"bold\" color=\"#747372\" halign=\"right\" line-through=\"0\" rotation=\"15.6\" letter-spacing=\"14.6\" line-height=\"14.6\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"96.3\" font-style=\"normal\" color=\"#75767574\" halign=\"left\" rotation=\"15.7\" letter-spacing=\"14.7\" line-height=\"14.7\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"center\" font-style=\"italic\" color=\"#787776\" halign=\"center\" rotation=\"15.8\" letter-spacing=\"14.8\" line-height=\"14.8\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words font-style=\"normal\" color=\"#797A7978\" halign=\"right\" rotation=\"15.9\" letter-spacing=\"14.9\" line-height=\"14.9\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"left\" default-x=\"96.6\" default-y=\"96.6\" relative-x=\"96.6\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#7C7B7A\" halign=\"left\" valign=\"bottom\" letter-spacing=\"15\" line-height=\"15\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"96.7\" default-y=\"96.7\" relative-x=\"96.7\" font-family=\"XYZ\" font-size=\"large\" color=\"#7D7E7D7C\" halign=\"center\" valign=\"baseline\" letter-spacing=\"15.1\" line-height=\"15.1\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"right\" default-y=\"96.8\" relative-x=\"96.8\" relative-y=\"96.8\" font-family=\"ABC\" font-size=\"1.1\" halign=\"right\" valign=\"top\" letter-spacing=\"15.2\" line-height=\"15.2\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"96.9\" relative-y=\"96.9\" font-family=\"DEF\" font-size=\"large\" halign=\"left\" valign=\"middle\" line-height=\"15.3\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"center\" default-x=\"97\" relative-y=\"97\" font-family=\"XYZ\" font-size=\"1.1\" halign=\"center\" valign=\"bottom\" underline=\"2\" line-height=\"15.4\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"97.1\" relative-y=\"97.1\" font-family=\"ABC\" font-size=\"large\" halign=\"right\" valign=\"baseline\" underline=\"0\" line-height=\"15.5\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"left\" default-y=\"97.2\" relative-y=\"97.2\" font-size=\"1.1\" font-weight=\"bold\" halign=\"left\" valign=\"top\" underline=\"1\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words default-y=\"97.3\" font-size=\"large\" font-weight=\"normal\" valign=\"middle\" underline=\"2\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"right\" default-x=\"97.4\" default-y=\"97.4\" relative-x=\"97.4\" font-style=\"italic\" font-weight=\"bold\" valign=\"bottom\" underline=\"0\" overline=\"0\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"97.5\" relative-x=\"97.5\" font-style=\"normal\" font-weight=\"normal\" valign=\"baseline\" underline=\"1\" overline=\"1\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"center\" relative-x=\"97.6\" font-style=\"italic\" font-weight=\"bold\" valign=\"top\" underline=\"2\" overline=\"2\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"97.7\" font-style=\"normal\" font-weight=\"normal\" valign=\"middle\" underline=\"0\" overline=\"0\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"left\" default-x=\"97.8\" default-y=\"97.8\" relative-y=\"97.8\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\" color=\"#949392\" underline=\"1\" overline=\"1\" line-through=\"1\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"97.9\" default-y=\"97.9\" relative-y=\"97.9\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\" color=\"#95969594\" underline=\"2\" overline=\"2\" line-through=\"2\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"right\" default-y=\"98\" relative-y=\"98\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\" color=\"#989796\" underline=\"0\" overline=\"0\" line-through=\"0\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words relative-y=\"98.1\" font-family=\"DEF\" color=\"#999A9998\" underline=\"1\" overline=\"1\" line-through=\"1\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"center\" default-x=\"98.2\" relative-x=\"98.2\" relative-y=\"98.2\" font-family=\"XYZ\" font-size=\"1.1\" color=\"#9C9B9A\" underline=\"2\" overline=\"2\" line-through=\"2\" rotation=\"17.6\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"98.3\" relative-x=\"98.3\" font-family=\"ABC\" font-size=\"large\" color=\"#9D9E9D9C\" overline=\"0\" line-through=\"0\" rotation=\"17.7\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"left\" default-y=\"98.4\" relative-x=\"98.4\" font-size=\"1.1\" color=\"#A09F9E\" halign=\"left\" overline=\"1\" line-through=\"1\" rotation=\"17.8\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words default-y=\"98.5\" relative-x=\"98.5\" font-size=\"large\" color=\"#A1A2A1A0\" halign=\"center\" overline=\"2\" line-through=\"2\" rotation=\"17.9\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"right\" default-x=\"98.6\" default-y=\"98.6\" font-size=\"1.1\" color=\"#A4A3A2\" halign=\"right\" overline=\"0\" line-through=\"0\" rotation=\"18\" letter-spacing=\"17\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"98.7\" font-size=\"large\" color=\"#A5A6A5A4\" halign=\"left\" overline=\"1\" line-through=\"1\" rotation=\"18.1\" letter-spacing=\"17.1\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"center\" relative-y=\"98.8\" font-style=\"italic\" font-size=\"1.1\" halign=\"center\" line-through=\"2\" rotation=\"18.2\" letter-spacing=\"17.2\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words relative-y=\"98.9\" font-style=\"normal\" font-size=\"large\" halign=\"right\" line-through=\"0\" rotation=\"18.3\" letter-spacing=\"17.3\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"left\" default-x=\"99\" default-y=\"99\" relative-x=\"99\" relative-y=\"99\" font-family=\"DEF\" font-style=\"italic\" font-weight=\"bold\" halign=\"left\" valign=\"bottom\" line-through=\"1\" rotation=\"18.4\" letter-spacing=\"17.4\" line-height=\"17.4\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"99.1\" default-y=\"99.1\" relative-x=\"99.1\" relative-y=\"99.1\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\" halign=\"center\" valign=\"baseline\" line-through=\"2\" rotation=\"18.5\" letter-spacing=\"17.5\" line-height=\"17.5\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"right\" default-y=\"99.2\" relative-x=\"99.2\" relative-y=\"99.2\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\" halign=\"right\" valign=\"top\" line-through=\"0\" rotation=\"18.6\" letter-spacing=\"17.6\" line-height=\"17.6\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"99.3\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\" halign=\"left\" valign=\"middle\" rotation=\"18.7\" letter-spacing=\"17.7\" line-height=\"17.7\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"center\" default-x=\"99.4\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\" halign=\"center\" valign=\"bottom\" rotation=\"18.8\" letter-spacing=\"17.8\" line-height=\"17.8\" xml:lang=\"ABC\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"99.5\" font-family=\"ABC\" font-weight=\"normal\" valign=\"baseline\" rotation=\"18.9\" letter-spacing=\"17.9\" line-height=\"17.9\" xml:lang=\"DEF\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"left\" default-y=\"99.6\" font-weight=\"bold\" valign=\"top\" underline=\"1\" rotation=\"19\" letter-spacing=\"18\" line-height=\"18\" xml:lang=\"XYZ\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words default-y=\"99.7\" font-weight=\"normal\" valign=\"middle\" underline=\"2\" rotation=\"19.1\" letter-spacing=\"18.1\" line-height=\"18.1\" xml:lang=\"ABC\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"right\" default-x=\"99.8\" default-y=\"99.8\" relative-x=\"99.8\" relative-y=\"99.8\" font-size=\"1.1\" font-weight=\"bold\" color=\"#BCBBBA\" valign=\"bottom\" underline=\"0\" letter-spacing=\"18.2\" line-height=\"18.2\" xml:lang=\"DEF\" xml:space=\"default\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"99.9\" relative-x=\"99.9\" relative-y=\"99.9\" font-size=\"large\" color=\"#BDBEBDBC\" valign=\"baseline\" underline=\"1\" letter-spacing=\"18.3\" line-height=\"18.3\" xml:lang=\"XYZ\" xml:space=\"preserve\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"center\" relative-x=\"100\" relative-y=\"100\" font-size=\"1.1\" color=\"#C0BFBE\" valign=\"top\" underline=\"2\" letter-spacing=\"18.4\" line-height=\"18.4\" xml:lang=\"ABC\" xml:space=\"default\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"100.1\" relative-y=\"100.1\" font-size=\"large\" color=\"#C1C2C1C0\" valign=\"middle\" underline=\"0\" letter-spacing=\"18.5\" line-height=\"18.5\" xml:lang=\"DEF\" xml:space=\"preserve\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"left\" default-x=\"100.2\" default-y=\"100.2\" relative-y=\"100.2\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#C4C3C2\" underline=\"1\" overline=\"1\" letter-spacing=\"18.6\" line-height=\"18.6\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"lro\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"100.3\" default-y=\"100.3\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#C5C6C5C4\" underline=\"2\" overline=\"2\" line-height=\"18.7\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rlo\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"right\" default-y=\"100.4\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" color=\"#C8C7C6\" underline=\"0\" overline=\"0\" line-height=\"18.8\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"ltr\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" color=\"#C9CAC9C8\" underline=\"1\" overline=\"1\" line-height=\"18.9\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rtl\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"center\" default-x=\"100.6\" relative-x=\"100.6\" font-family=\"XYZ\" font-style=\"italic\" color=\"#CCCBCA\" halign=\"center\" underline=\"2\" overline=\"2\" line-height=\"19\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"100.7\" relative-x=\"100.7\" font-family=\"ABC\" font-style=\"normal\" color=\"#CDCECDCC\" halign=\"right\" underline=\"0\" overline=\"0\" line-height=\"19.1\" xml:lang=\"DEF\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"left\" default-y=\"100.8\" relative-x=\"100.8\" relative-y=\"100.8\" font-style=\"italic\" font-weight=\"bold\" halign=\"left\" underline=\"1\" overline=\"1\" line-through=\"1\" xml:lang=\"XYZ\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words default-y=\"100.9\" relative-x=\"100.9\" relative-y=\"100.9\" font-weight=\"normal\" halign=\"center\" overline=\"2\" line-through=\"2\" xml:lang=\"ABC\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::oval ) );
	expected = "<words justify=\"right\" default-x=\"101\" default-y=\"101\" relative-y=\"101\" font-weight=\"bold\" halign=\"right\" overline=\"0\" line-through=\"0\" xml:lang=\"DEF\" xml:space=\"default\" dir=\"lro\" enclosure=\"oval\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::circle ) );
	expected = "<words default-x=\"101.1\" relative-y=\"101.1\" font-weight=\"normal\" halign=\"left\" overline=\"1\" line-through=\"1\" xml:lang=\"XYZ\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"circle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::bracket ) );
	expected = "<words justify=\"center\" relative-y=\"101.2\" font-weight=\"bold\" halign=\"center\" overline=\"2\" line-through=\"2\" xml:lang=\"ABC\" xml:space=\"default\" dir=\"ltr\" enclosure=\"bracket\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::triangle ) );
	expected = "<words font-weight=\"normal\" halign=\"right\" overline=\"0\" line-through=\"0\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"triangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::lro ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::diamond ) );
	expected = "<words justify=\"left\" default-x=\"101.4\" default-y=\"101.4\" relative-x=\"101.4\" font-family=\"DEF\" font-size=\"1.1\" font-weight=\"bold\" halign=\"left\" valign=\"bottom\" overline=\"1\" line-through=\"1\" rotation=\"20.8\" xml:space=\"default\" dir=\"lro\" enclosure=\"diamond\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rlo ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::none ) );
	expected = "<words default-x=\"101.5\" default-y=\"101.5\" relative-x=\"101.5\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\" halign=\"center\" valign=\"baseline\" overline=\"2\" line-through=\"2\" rotation=\"20.9\" xml:space=\"preserve\" dir=\"rlo\" enclosure=\"none\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::ltr ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::rectangle ) );
	expected = "<words justify=\"right\" default-y=\"101.6\" relative-x=\"101.6\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" halign=\"right\" valign=\"top\" line-through=\"0\" rotation=\"21\" xml:space=\"default\" dir=\"ltr\" enclosure=\"rectangle\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEsWords )
{
	...
	object.setDir( MxEnumTextDirection( lexicon::enums::TextDirection::rtl ) );
	object.setEnclosure( MxEnumEnclosureShape( lexicon::enums::EnclosureShape::square ) );
	expected = "<words relative-x=\"101.7\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" valign=\"middle\" line-through=\"1\" rotation=\"21.1\" xml:space=\"preserve\" dir=\"rtl\" enclosure=\"square\">D,E,F</words>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
