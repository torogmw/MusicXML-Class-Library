...
TEST( ctorAttributeValues0, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues1, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues5, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues6, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues7, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues8, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues9, MxEeCoda )
{
	MxEeCoda object;
...
TEST( ctorAttributeValues10, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getIsMaxOccursUnbounded, MxEeCoda )
{
	MxEeCoda object;
	bool expected = true;
...
TEST( getClassName, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = "MxEeCoda";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = "coda";
	std::string actual = object.getXmlTypeName();
	CHECK_EQUAL( expected, actual )
}
TEST( getDocumentation, MxEeCoda )
{
	MxEeCoda object;
	std::string expected = "The coda element is the visual indicator of a coda sign. A sound element is needed to guide playback applications reliably.";
...
TEST( getIsDefaultXRequired0, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsHalignRequired9, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsValignRequired10, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsHalignPresent9, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsValignPresent10, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsHalignDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getIsValignDefaultDefined, MxEeCoda )
{
	MxEeCoda object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getDefaultYDefaultValue, MxEeCoda )
{
	MxEeCoda object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEeCoda )
{
	MxEeCoda object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEeCoda )
{
	MxEeCoda object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getFontStyleDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getFontSizeDefaultValue, MxEeCoda )
{
	MxEeCoda object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getColorDefaultValue, MxEeCoda )
{
	MxEeCoda object;
	MxColor expected;
...
TEST( getHalignDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( getValignDefaultValue, MxEeCoda )
{
	MxEeCoda object;
...
TEST( toString0, MxEeCoda )
{
	...
	object.setIsHalignPresent( true );
	object.setIsValignPresent( true );
	expected = "<coda default-x=\"41.5\" default-y=\"41.5\" relative-x=\"41.5\" relative-y=\"41.5\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#292A2928\" halign=\"center\" valign=\"top\"/>";
...
TEST( toString1, MxEeCoda )
{
	...
	expected = "<coda default-y=\"41.6\" relative-x=\"41.6\" relative-y=\"41.6\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#2C2B2A\" halign=\"right\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEeCoda )
{
	...
	expected = "<coda default-x=\"41.7\" relative-x=\"41.7\" relative-y=\"41.7\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#2D2E2D2C\" halign=\"left\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEeCoda )
{
	...
	expected = "<coda relative-y=\"41.8\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#302F2E\" halign=\"center\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"41.9\" default-y=\"41.9\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#31323130\" halign=\"right\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"42\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#343332\" halign=\"left\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"42.1\" relative-x=\"42.1\" font-size=\"large\" font-weight=\"normal\" color=\"#35363534\" halign=\"center\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"42.2\" font-weight=\"bold\" color=\"#383736\" halign=\"right\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"42.3\" default-y=\"42.3\" relative-x=\"42.3\" relative-y=\"42.3\" color=\"#393A3938\" halign=\"left\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"42.4\" relative-y=\"42.4\" halign=\"center\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"42.5\" relative-y=\"42.5\" font-family=\"DEF\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"42.6\" font-family=\"XYZ\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"42.7\" default-y=\"42.7\" relative-x=\"42.7\" font-family=\"ABC\" font-style=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"42.8\" relative-x=\"42.8\" font-family=\"DEF\" font-style=\"italic\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"42.9\" relative-x=\"42.9\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-style=\"italic\" font-size=\"1.1\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"43.1\" default-y=\"43.1\" relative-y=\"43.1\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"43.2\" relative-y=\"43.2\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"43.3\" relative-x=\"43.3\" relative-y=\"43.3\" font-size=\"large\" font-weight=\"normal\" color=\"#4D4E4D4C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"43.4\" relative-y=\"43.4\" font-size=\"1.1\" font-weight=\"bold\" color=\"#504F4E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"43.5\" default-y=\"43.5\" relative-x=\"43.5\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\" color=\"#51525150\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"43.6\" font-family=\"ABC\" font-weight=\"bold\" color=\"#545352\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"43.7\" font-family=\"DEF\" font-weight=\"normal\" color=\"#55565554\" halign=\"right\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-family=\"XYZ\" font-weight=\"bold\" color=\"#585756\" halign=\"left\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"43.9\" default-y=\"43.9\" relative-x=\"43.9\" relative-y=\"43.9\" font-family=\"ABC\" font-style=\"normal\" color=\"#595A5958\" halign=\"center\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"44\" relative-x=\"44\" relative-y=\"44\" font-style=\"italic\" color=\"#5C5B5A\" halign=\"right\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"44.1\" relative-x=\"44.1\" relative-y=\"44.1\" font-style=\"normal\" color=\"#5D5E5D5C\" halign=\"left\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"44.2\" font-style=\"italic\" halign=\"center\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"44.3\" default-y=\"44.3\" font-style=\"normal\" font-size=\"large\" halign=\"right\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"44.4\" font-style=\"italic\" font-size=\"1.1\" halign=\"left\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"44.5\" relative-x=\"44.5\" font-family=\"ABC\" font-size=\"large\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"44.6\" font-family=\"DEF\" font-size=\"1.1\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"44.7\" default-y=\"44.7\" relative-x=\"44.7\" relative-y=\"44.7\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"44.8\" relative-y=\"44.8\" font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"44.9\" relative-y=\"44.9\" font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"45\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"45.1\" default-y=\"45.1\" relative-x=\"45.1\" font-style=\"normal\" font-weight=\"normal\" color=\"#71727170\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"45.2\" relative-x=\"45.2\" font-style=\"italic\" font-weight=\"bold\" color=\"#747372\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"45.3\" relative-x=\"45.3\" font-style=\"normal\" font-weight=\"normal\" color=\"#75767574\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-style=\"italic\" font-weight=\"bold\" color=\"#787776\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"45.5\" default-y=\"45.5\" relative-y=\"45.5\" font-family=\"DEF\" font-style=\"normal\" color=\"#797A7978\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"45.6\" relative-y=\"45.6\" font-family=\"XYZ\" font-style=\"italic\" color=\"#7C7B7A\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"45.7\" relative-x=\"45.7\" relative-y=\"45.7\" font-family=\"ABC\" font-size=\"large\" color=\"#7D7E7D7C\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"45.8\" relative-y=\"45.8\" font-family=\"DEF\" font-size=\"1.1\" color=\"#807F7E\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"45.9\" default-y=\"45.9\" relative-x=\"45.9\" font-family=\"XYZ\" font-size=\"large\" color=\"#81828180\" halign=\"left\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"46\" font-size=\"1.1\" halign=\"center\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"46.1\" font-size=\"large\" halign=\"right\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-size=\"1.1\" halign=\"left\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"46.3\" default-y=\"46.3\" relative-x=\"46.3\" relative-y=\"46.3\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" halign=\"center\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"46.4\" relative-x=\"46.4\" relative-y=\"46.4\" font-style=\"italic\" font-weight=\"bold\" halign=\"right\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"46.5\" relative-x=\"46.5\" relative-y=\"46.5\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"46.6\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"46.7\" default-y=\"46.7\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"46.8\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"46.9\" relative-x=\"46.9\" font-family=\"ABC\" font-weight=\"normal\" color=\"#95969594\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"47\" font-weight=\"bold\" color=\"#989796\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"47.1\" default-y=\"47.1\" relative-x=\"47.1\" relative-y=\"47.1\" font-size=\"large\" color=\"#999A9998\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"47.2\" relative-y=\"47.2\" font-size=\"1.1\" color=\"#9C9B9A\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"47.3\" relative-y=\"47.3\" font-size=\"large\" color=\"#9D9E9D9C\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"47.4\" font-size=\"1.1\" color=\"#A09F9E\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"47.5\" default-y=\"47.5\" relative-x=\"47.5\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#A1A2A1A0\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"47.6\" relative-x=\"47.6\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#A4A3A2\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"47.7\" relative-x=\"47.7\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#A5A6A5A4\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-family=\"ABC\" font-style=\"italic\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"47.9\" default-y=\"47.9\" relative-y=\"47.9\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"48\" relative-y=\"48\" font-style=\"italic\" font-weight=\"bold\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"48.1\" relative-x=\"48.1\" relative-y=\"48.1\" font-weight=\"normal\" halign=\"center\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"48.2\" relative-y=\"48.2\" font-weight=\"bold\" halign=\"right\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"48.3\" default-y=\"48.3\" relative-x=\"48.3\" font-weight=\"normal\" halign=\"left\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"48.4\" font-weight=\"bold\" halign=\"center\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"48.5\" font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"48.7\" default-y=\"48.7\" relative-x=\"48.7\" relative-y=\"48.7\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#B9BAB9B8\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"48.8\" relative-x=\"48.8\" relative-y=\"48.8\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#BCBBBA\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"48.9\" relative-x=\"48.9\" relative-y=\"48.9\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#BDBEBDBC\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"49\" font-style=\"italic\" font-size=\"1.1\" color=\"#C0BFBE\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"49.1\" default-y=\"49.1\" font-style=\"normal\" font-size=\"large\" color=\"#C1C2C1C0\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"49.2\" font-style=\"italic\" color=\"#C4C3C2\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"49.3\" relative-x=\"49.3\" color=\"#C5C6C5C4\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"49.4\" color=\"#C8C7C6\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"49.5\" default-y=\"49.5\" relative-x=\"49.5\" relative-y=\"49.5\" font-family=\"XYZ\" font-weight=\"normal\" color=\"#C9CAC9C8\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"49.6\" relative-y=\"49.6\" font-family=\"ABC\" font-weight=\"bold\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"49.7\" relative-y=\"49.7\" font-family=\"DEF\" font-weight=\"normal\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"49.8\" font-family=\"XYZ\" font-weight=\"bold\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"49.9\" default-y=\"49.9\" relative-x=\"49.9\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"50\" relative-x=\"50\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" halign=\"right\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"50.1\" relative-x=\"50.1\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" halign=\"left\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" halign=\"center\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"50.3\" default-y=\"50.3\" relative-y=\"50.3\" font-style=\"normal\" font-size=\"large\" halign=\"right\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"50.4\" relative-y=\"50.4\" font-style=\"italic\" font-size=\"1.1\" halign=\"left\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"50.5\" relative-x=\"50.5\" relative-y=\"50.5\" font-family=\"ABC\" font-size=\"large\" color=\"#DDDEDDDC\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-x=\"50.6\" relative-y=\"50.6\" font-family=\"DEF\" color=\"#E0DFDE\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"50.7\" default-y=\"50.7\" relative-x=\"50.7\" font-family=\"XYZ\" color=\"#E1E2E1E0\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"50.8\" font-family=\"ABC\" color=\"#E4E3E2\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"50.9\" font-family=\"DEF\" color=\"#E5E6E5E4\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda color=\"#E8E7E6\" valign=\"baseline\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::top ) );
	expected = "<coda default-x=\"51.1\" default-y=\"51.1\" relative-x=\"51.1\" relative-y=\"51.1\" font-style=\"normal\" font-weight=\"normal\" color=\"#E9EAE9E8\" valign=\"top\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::right ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::middle ) );
	expected = "<coda default-y=\"51.2\" relative-x=\"51.2\" relative-y=\"51.2\" font-style=\"italic\" font-weight=\"bold\" color=\"#ECEBEA\" valign=\"middle\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::left ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::bottom ) );
	expected = "<coda default-x=\"51.3\" relative-x=\"51.3\" relative-y=\"51.3\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#EDEEEDEC\" valign=\"bottom\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEeCoda )
{
	...
	object.setHalign( MxEnumLeftCenterRight( lexicon::enums::LeftCenterRight::center ) );
	object.setValign( MxEnumValign( lexicon::enums::Valign::baseline ) );
	expected = "<coda relative-y=\"51.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\"/>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
