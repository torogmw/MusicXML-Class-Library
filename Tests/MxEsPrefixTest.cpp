...
TEST( Ctor, MxEsPrefix )
{
	MxEsPrefix object;
	CHECK( true )
}
TEST( ctorAttributeValues0, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( ctorAttributeValues1, MxEsPrefix )
{
	MxEsPrefix object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues2, MxEsPrefix )
{
	MxEsPrefix object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues3, MxEsPrefix )
{
	MxEsPrefix object;
	std::string expected = ( MxNumberTenths(  ) ).toString();
...
TEST( ctorAttributeValues4, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( ctorAttributeValues5, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( ctorAttributeValues6, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( ctorAttributeValues7, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( ctorAttributeValues8, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getIsMaxOccursUnbounded, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( ctorValue0, MxEsPrefix )
{
	MxEsPrefix object( XsString( "" ) );
	std::string expected;
	std::string actual;
	expected = "";
...
TEST( ctorValue2, MxEsPrefix )
{
	MxEsPrefix object( XsString( "D,E,F" ) );
	std::string expected;
	std::string actual;
	expected = "D,E,F";
	actual = object.getValue().toString();
...
TEST( ctorValue4, MxEsPrefix )
{
	MxEsPrefix object( XsString( "X,Y,Z" ) );
	std::string expected;
	std::string actual;
	expected = "X,Y,Z";
	actual = object.getValue().toString();
...
TEST( getClassName, MxEsPrefix )
{
	MxEsPrefix object;
	std::string expected = "MxEsPrefix";
	std::string actual = object.getClassName();
	CHECK_EQUAL( expected, actual )
}
TEST( getXmlTypeName, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getDocumentation, MxEsPrefix )
{
	MxEsPrefix object;
	std::string expected = "Values for the prefix element include the accidental values sharp, flat, natural, double-sharp, flat-flat, and sharp-sharp. The prefix element may contain additional values for symbols specific to particular figured bass styles.";
...
TEST( setFontFamily4, MxEsPrefix )
{
...
TEST( setFontWeight7, MxEsPrefix )
{
...
TEST( getIsDefaultXRequired0, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsDefaultYRequired1, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeXRequired2, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeYRequired3, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontFamilyRequired4, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontStyleRequired5, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontSizeRequired6, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontWeightRequired7, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsColorRequired8, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsDefaultXPresent0, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsDefaultYPresent1, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeXPresent2, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeYPresent3, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontFamilyPresent4, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontStylePresent5, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontSizePresent6, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontWeightPresent7, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsColorPresent8, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsDefaultXDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsDefaultYDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeXDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsRelativeYDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontFamilyDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontStyleDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontSizeDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsFontWeightDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getIsColorDefaultDefined, MxEsPrefix )
{
	MxEsPrefix object;
	bool expected = false;
...
TEST( getDefaultXDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getDefaultYDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
	MxNumberTenths expected;
...
TEST( getRelativeXDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
	MxNumberTenths expected;
...
TEST( getRelativeYDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
	MxNumberTenths expected;
...
TEST( getFontFamilyDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getFontStyleDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getFontSizeDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
	MxFontSize expected;
...
TEST( getFontWeightDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
...
TEST( getColorDefaultValue, MxEsPrefix )
{
	MxEsPrefix object;
	MxColor expected;
...
TEST( toString0, MxEsPrefix )
{
	...
	object.setIsFontWeightPresent( true );
	object.setIsColorPresent( true );
	expected = "<prefix default-x=\"202.9\" default-y=\"202.9\" relative-x=\"202.9\" relative-y=\"202.9\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#080706\">D,E,F</prefix>";
...
TEST( toString1, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"203\" relative-x=\"203\" relative-y=\"203\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#090A0908\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString2, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"203.1\" relative-x=\"203.1\" relative-y=\"203.1\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#0C0B0A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString3, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"203.2\" font-family=\"ABC\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#0D0E0D0C\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString4, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"203.3\" default-y=\"203.3\" font-family=\"DEF\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#100F0E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString5, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"203.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\" color=\"#11121110\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString6, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"203.5\" relative-x=\"203.5\" font-size=\"large\" font-weight=\"normal\" color=\"#141312\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString7, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"203.6\" font-weight=\"bold\" color=\"#15161514\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString8, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"203.7\" default-y=\"203.7\" relative-x=\"203.7\" relative-y=\"203.7\" color=\"#181716\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString9, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"203.8\" relative-y=\"203.8\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString10, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"203.9\" relative-y=\"203.9\" font-family=\"DEF\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString11, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"204\" font-family=\"XYZ\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString12, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"204.1\" default-y=\"204.1\" relative-x=\"204.1\" font-family=\"ABC\" font-style=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString13, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"204.2\" relative-x=\"204.2\" font-family=\"DEF\" font-style=\"italic\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString14, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"204.3\" relative-x=\"204.3\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString15, MxEsPrefix )
{
	...
	expected = "<prefix font-style=\"italic\" font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString16, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"204.5\" default-y=\"204.5\" relative-y=\"204.5\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString17, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"204.6\" relative-y=\"204.6\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString18, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"204.7\" relative-x=\"204.7\" relative-y=\"204.7\" font-size=\"large\" font-weight=\"normal\" color=\"#2C2B2A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString19, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"204.8\" relative-y=\"204.8\" font-size=\"1.1\" font-weight=\"bold\" color=\"#2D2E2D2C\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString20, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"204.9\" default-y=\"204.9\" relative-x=\"204.9\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\" color=\"#302F2E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString21, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"205\" font-family=\"ABC\" font-weight=\"bold\" color=\"#31323130\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString22, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"205.1\" font-family=\"DEF\" font-weight=\"normal\" color=\"#343332\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString23, MxEsPrefix )
{
	...
	expected = "<prefix font-family=\"XYZ\" font-weight=\"bold\" color=\"#35363534\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString24, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"205.3\" default-y=\"205.3\" relative-x=\"205.3\" relative-y=\"205.3\" font-family=\"ABC\" font-style=\"normal\" color=\"#383736\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString25, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"205.4\" relative-x=\"205.4\" relative-y=\"205.4\" font-style=\"italic\" color=\"#393A3938\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString26, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"205.5\" relative-x=\"205.5\" relative-y=\"205.5\" font-style=\"normal\" color=\"#3C3B3A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString27, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"205.6\" font-style=\"italic\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString28, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"205.7\" default-y=\"205.7\" font-style=\"normal\" font-size=\"large\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString29, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"205.8\" font-style=\"italic\" font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString30, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"205.9\" relative-x=\"205.9\" font-family=\"ABC\" font-size=\"large\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString31, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"206\" font-family=\"DEF\" font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString32, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"206.1\" default-y=\"206.1\" relative-x=\"206.1\" relative-y=\"206.1\" font-family=\"XYZ\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString33, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"206.2\" relative-y=\"206.2\" font-family=\"ABC\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString34, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"206.3\" relative-y=\"206.3\" font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString35, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"206.4\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString36, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"206.5\" default-y=\"206.5\" relative-x=\"206.5\" font-style=\"normal\" font-weight=\"normal\" color=\"#504F4E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString37, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"206.6\" relative-x=\"206.6\" font-style=\"italic\" font-weight=\"bold\" color=\"#51525150\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString38, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"206.7\" relative-x=\"206.7\" font-style=\"normal\" font-weight=\"normal\" color=\"#545352\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString39, MxEsPrefix )
{
	...
	expected = "<prefix font-style=\"italic\" font-weight=\"bold\" color=\"#55565554\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString40, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"206.9\" default-y=\"206.9\" relative-y=\"206.9\" font-family=\"DEF\" font-style=\"normal\" color=\"#585756\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString41, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"207\" relative-y=\"207\" font-family=\"XYZ\" font-style=\"italic\" color=\"#595A5958\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString42, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"207.1\" relative-x=\"207.1\" relative-y=\"207.1\" font-family=\"ABC\" font-size=\"large\" color=\"#5C5B5A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString43, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"207.2\" relative-y=\"207.2\" font-family=\"DEF\" font-size=\"1.1\" color=\"#5D5E5D5C\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString44, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"207.3\" default-y=\"207.3\" relative-x=\"207.3\" font-family=\"XYZ\" font-size=\"large\" color=\"#605F5E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString45, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"207.4\" font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString46, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"207.5\" font-size=\"large\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString47, MxEsPrefix )
{
	...
	expected = "<prefix font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString48, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"207.7\" default-y=\"207.7\" relative-x=\"207.7\" relative-y=\"207.7\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString49, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"207.8\" relative-x=\"207.8\" relative-y=\"207.8\" font-style=\"italic\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString50, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"207.9\" relative-x=\"207.9\" relative-y=\"207.9\" font-family=\"XYZ\" font-style=\"normal\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString51, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"208\" font-family=\"ABC\" font-style=\"italic\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString52, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"208.1\" default-y=\"208.1\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString53, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"208.2\" font-family=\"XYZ\" font-style=\"italic\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString54, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"208.3\" relative-x=\"208.3\" font-family=\"ABC\" font-weight=\"normal\" color=\"#747372\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString55, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"208.4\" font-weight=\"bold\" color=\"#75767574\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString56, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"208.5\" default-y=\"208.5\" relative-x=\"208.5\" relative-y=\"208.5\" font-size=\"large\" color=\"#787776\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString57, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"208.6\" relative-y=\"208.6\" font-size=\"1.1\" color=\"#797A7978\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString58, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"208.7\" relative-y=\"208.7\" font-size=\"large\" color=\"#7C7B7A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString59, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"208.8\" font-size=\"1.1\" color=\"#7D7E7D7C\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString60, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"208.9\" default-y=\"208.9\" relative-x=\"208.9\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#807F7E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString61, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"209\" relative-x=\"209\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#81828180\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString62, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"209.1\" relative-x=\"209.1\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#848382\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString63, MxEsPrefix )
{
	...
	expected = "<prefix font-family=\"ABC\" font-style=\"italic\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString64, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"209.3\" default-y=\"209.3\" relative-y=\"209.3\" font-family=\"DEF\" font-style=\"normal\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString65, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"209.4\" relative-y=\"209.4\" font-style=\"italic\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString66, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"209.5\" relative-x=\"209.5\" relative-y=\"209.5\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString67, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"209.6\" relative-y=\"209.6\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString68, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"209.7\" default-y=\"209.7\" relative-x=\"209.7\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString69, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"209.8\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString70, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"209.9\" font-family=\"DEF\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString71, MxEsPrefix )
{
	...
	expected = "<prefix font-family=\"XYZ\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString72, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"210.1\" default-y=\"210.1\" relative-x=\"210.1\" relative-y=\"210.1\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" color=\"#989796\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString73, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"210.2\" relative-x=\"210.2\" relative-y=\"210.2\" font-family=\"DEF\" font-style=\"italic\" font-size=\"1.1\" color=\"#999A9998\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString74, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"210.3\" relative-x=\"210.3\" relative-y=\"210.3\" font-family=\"XYZ\" font-style=\"normal\" font-size=\"large\" color=\"#9C9B9A\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString75, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"210.4\" font-style=\"italic\" font-size=\"1.1\" color=\"#9D9E9D9C\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString76, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"210.5\" default-y=\"210.5\" font-style=\"normal\" font-size=\"large\" color=\"#A09F9E\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString77, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"210.6\" font-style=\"italic\" color=\"#A1A2A1A0\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString78, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"210.7\" relative-x=\"210.7\" color=\"#A4A3A2\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString79, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"210.8\" color=\"#A5A6A5A4\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString80, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"210.9\" default-y=\"210.9\" relative-x=\"210.9\" relative-y=\"210.9\" font-family=\"XYZ\" font-weight=\"normal\" color=\"#A8A7A6\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString81, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"211\" relative-y=\"211\" font-family=\"ABC\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString82, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"211.1\" relative-y=\"211.1\" font-family=\"DEF\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString83, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"211.2\" font-family=\"XYZ\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString84, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"211.3\" default-y=\"211.3\" relative-x=\"211.3\" font-family=\"ABC\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString85, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"211.4\" relative-x=\"211.4\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString86, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"211.5\" relative-x=\"211.5\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString87, MxEsPrefix )
{
	...
	expected = "<prefix font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString88, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"211.7\" default-y=\"211.7\" relative-y=\"211.7\" font-style=\"normal\" font-size=\"large\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString89, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"211.8\" relative-y=\"211.8\" font-style=\"italic\" font-size=\"1.1\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString90, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"211.9\" relative-x=\"211.9\" relative-y=\"211.9\" font-family=\"ABC\" font-size=\"large\" color=\"#BCBBBA\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString91, MxEsPrefix )
{
	...
	expected = "<prefix relative-x=\"212\" relative-y=\"212\" font-family=\"DEF\" color=\"#BDBEBDBC\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString92, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"212.1\" default-y=\"212.1\" relative-x=\"212.1\" font-family=\"XYZ\" color=\"#C0BFBE\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString93, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"212.2\" font-family=\"ABC\" color=\"#C1C2C1C0\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString94, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"212.3\" font-family=\"DEF\" color=\"#C4C3C2\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString95, MxEsPrefix )
{
	...
	expected = "<prefix color=\"#C5C6C5C4\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString96, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"212.5\" default-y=\"212.5\" relative-x=\"212.5\" relative-y=\"212.5\" font-style=\"normal\" font-weight=\"normal\" color=\"#C8C7C6\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString97, MxEsPrefix )
{
	...
	expected = "<prefix default-y=\"212.6\" relative-x=\"212.6\" relative-y=\"212.6\" font-style=\"italic\" font-weight=\"bold\" color=\"#C9CAC9C8\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString98, MxEsPrefix )
{
	...
	expected = "<prefix default-x=\"212.7\" relative-x=\"212.7\" relative-y=\"212.7\" font-style=\"normal\" font-size=\"large\" font-weight=\"normal\" color=\"#CCCBCA\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
...
TEST( toString99, MxEsPrefix )
{
	...
	expected = "<prefix relative-y=\"212.8\" font-style=\"italic\" font-size=\"1.1\" font-weight=\"bold\">D,E,F</prefix>";
	actual = object.toString();
	CHECK_EQUAL( expected, actual )
	std::stringstream sstr1;
	object.stream( sstr1 );
